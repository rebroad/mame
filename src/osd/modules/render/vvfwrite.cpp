...
{
	// LINE command: 13 bytes total
	m_frame_buffer.push_back(static_cast<uint8_t>(vvf_command::LINE));

	// Coordinates (signed 16-bit)
	int16_t coord;
	coord = static_cast<int16_t>(x1);
