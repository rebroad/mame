...
const options_entry emu_options::s_option_entries[] =
{
	...
	{ OPTION_FFMPEG_ASYNC ";ffmpeg_noasync",             "1",         core_options::option_type::BOOLEAN,    "use async background encoding (1) or sync direct encoding (0)" },
	...
	{ OPTION_ANTITHROTTLE,                               "0",         core_options::option_type::BOOLEAN,    "enable antithrottle to compensate for browser FPS throttling by advancing emulation more per frame" },
