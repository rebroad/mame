...
void routine_bd9e_impl(CPU6809& cpu) {
    ...
    // BE28: BCS $0084
    if (cpu.carry_flag()) cpu.m_pc = 0xBDAE;
    ...
    // BE52: BPL $00AE
    if (!cpu.negative_flag()) cpu.m_pc = 0xBE02;
    ...
    // BE5F: BCS $009C
    if (cpu.carry_flag()) cpu.m_pc = 0xBDFD;
    ...
    // BF4C: BEQ $01DE
    if (cpu.zero_flag()) cpu.m_pc = 0xBF2C;
    ...
    // BF64: BCS $01CB
    if (cpu.carry_flag()) cpu.m_pc = 0xBF31;
    ...
    // BF77: BCS $01DE
    if (cpu.carry_flag()) cpu.m_pc = 0xBF57;
