...
void routine_cd20_impl(StarWarsCPU& cpu) {
    // Converted from rom_disasm_cd20.md
    // Address: 0xCD20
    ...
    // CDC0: BMI $009D
    if (cpu.negative_flag()) cpu.state_.pc = 0xCE5F;
    ...
    // CE5A: BRA $0183
    cpu.state_.pc = 0xCFDF;

    // CE5E: BRA $0197
    cpu.state_.pc = 0xCFF7;
    ...
    // CED3: BRA $01E6
    cpu.state_.pc = 0xD0BB;

    // CED6: XANDCC #$33
    // TODO: Convert XANDCC #$33

    // CED8: BRA $01FB
    cpu.state_.pc = 0xD0D5;
