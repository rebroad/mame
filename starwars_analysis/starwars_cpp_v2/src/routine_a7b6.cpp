...
void routine_a7b6_impl(StarWarsCPU& cpu) {
    ...
    // A850: BEQ $00AB
    if (cpu.zero_flag()) cpu.state_.pc += 0x00AB;
    ...
    // A92C: BPL $017C
    if (!cpu.negative_flag()) cpu.state_.pc += 0x017C;
