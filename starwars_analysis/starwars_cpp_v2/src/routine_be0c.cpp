...
void routine_be0c_impl(CPU6809& cpu) {
    ...
    // BE28: BCS $0016
    if (cpu.carry_flag()) cpu.m_pc = 0xBE40;
    ...
    // BE52: BPL $0040
    if (!cpu.negative_flag()) cpu.m_pc = 0xBE94;
    ...
    // BE5F: BCS $002E
    if (cpu.carry_flag()) cpu.m_pc = 0xBE8F;
    ...
    // BF4C: BEQ $0170
    if (cpu.zero_flag()) cpu.m_pc = 0xBFBE;
    ...
    // BF77: BCS $0170
    if (cpu.carry_flag()) cpu.m_pc = 0xBFE9;
    ...
    // BFA3: BEQ $01A8
    if (cpu.zero_flag()) cpu.m_pc = 0xBF4D;
