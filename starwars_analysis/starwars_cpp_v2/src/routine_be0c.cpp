...
void routine_be0c_impl(StarWarsCPU& cpu) {
    // Converted from rom_disasm_be0c.md
    // Address: 0xBE0C
    ...
    // BE28: BCS $0016
    if (cpu.carry_flag()) cpu.state_.pc = 0xBE40;
    ...
    // BE52: BPL $0040
    if (!cpu.negative_flag()) cpu.state_.pc = 0xBE94;
    ...
    // BE5F: BCS $002E
    if (cpu.carry_flag()) cpu.state_.pc = 0xBE8F;
    ...
    // BF4C: BEQ $0170
    if (cpu.zero_flag()) cpu.state_.pc = 0xC0BE;
    ...
    // BF64: BCS $015D
    if (cpu.carry_flag()) cpu.state_.pc = 0xC0C3;
    ...
    // BF77: BCS $0170
    if (cpu.carry_flag()) cpu.state_.pc = 0xC0E9;
    ...
    // BFA3: BEQ $01A8
    if (cpu.zero_flag()) cpu.state_.pc = 0xC14D;
    ...
    // BFED: BCS $01E8
    if (cpu.carry_flag()) cpu.state_.pc = 0xC1D7;

    // BFEF: LDD #$1ED4
    cpu.state_.d = 0x1ED4;

    // BFF2: BRA $01EB
    cpu.state_.pc = 0xC1DF;
