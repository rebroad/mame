...
void routine_be02_impl(StarWarsCPU& cpu) {
    // Converted from rom_disasm_be02.md
    // Address: 0xBE02
    ...
    // BE28: BCS $0020
    if (cpu.carry_flag()) cpu.state_.pc = 0xBE4A;
    ...
    // BE52: BPL $004A
    if (!cpu.negative_flag()) cpu.state_.pc = 0xBE9E;
    ...
    // BE5F: BCS $0038
    if (cpu.carry_flag()) cpu.state_.pc = 0xBE99;
    ...
    // BF4C: BEQ $017A
    if (cpu.zero_flag()) cpu.state_.pc = 0xBFC8;
    ...
    // BF77: BCS $017A
    if (cpu.carry_flag()) cpu.state_.pc = 0xBFF3;
    ...
    // BFA3: BEQ $01B2
    if (cpu.zero_flag()) cpu.state_.pc = 0xBF57;
    ...
    // BFED: BCS $01F2
    if (cpu.carry_flag()) cpu.state_.pc = 0xBFE1;

    // BFEF: LDD #$1ED4
    cpu.state_.d = 0x1ED4;

    // BFF2: BRA $01F5
    cpu.state_.pc = 0xBFE9;
