...
void routine_bd71_impl(StarWarsCPU& cpu) {
    // Converted from rom_disasm_bd71.md
    // Address: 0xBD71
    ...
    // BE28: BCS $00B1
    if (cpu.carry_flag()) cpu.state_.pc = 0xBDDB;
    ...
    // BE52: BPL $00DB
    if (!cpu.negative_flag()) cpu.state_.pc = 0xBE2F;
    ...
    // BE5F: BCS $00C9
    if (cpu.carry_flag()) cpu.state_.pc = 0xBE2A;
    ...
    // BF64: BCS $01F8
    if (cpu.carry_flag()) cpu.state_.pc = 0xBF5E;
