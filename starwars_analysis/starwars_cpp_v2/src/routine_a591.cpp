...
void routine_a591_impl(StarWarsCPU& cpu) {
    ...
    // A5FA: BPL $006E
    if (!cpu.negative_flag()) cpu.state_.pc += 0x006E;
    ...
    // A713: BCS $0177
    if (cpu.carry_flag()) cpu.state_.pc += 0x0177;
    ...
    // A781: BCC $01F3
    if (!cpu.carry_flag()) cpu.state_.pc += 0x01F3;
    ...
    // A78A: BPL $01FF
    if (!cpu.negative_flag()) cpu.state_.pc += 0x01FF;
