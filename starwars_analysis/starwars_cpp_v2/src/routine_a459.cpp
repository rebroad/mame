...
void routine_a459_impl(StarWarsCPU& cpu) {
    ...
    // A602: BPL $01AE
    if (!cpu.negative_flag()) cpu.state_.pc += 0x01AE;
    ...
    // A63C: BEQ $01FB
    if (cpu.zero_flag()) cpu.state_.pc += 0x01FB;
    ...
    // A647: BPL $01F3
    if (!cpu.negative_flag()) cpu.state_.pc += 0x01F3;
