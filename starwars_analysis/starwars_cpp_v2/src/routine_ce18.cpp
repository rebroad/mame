...
void routine_ce18_impl(StarWarsCPU& cpu) {
    // Converted from rom_disasm_ce18.md
    // Address: 0xCE18
    ...
    // CE5A: BRA $008B
    cpu.state_.pc = 0xCEE7;

    // CE5E: BRA $009F
    cpu.state_.pc = 0xCEFF;
    ...
    // CED3: BRA $00EE
    cpu.state_.pc = 0xCFC3;

    // CED6: XANDCC #$33
    // TODO: Convert XANDCC #$33

    // CED8: BRA $0103
    cpu.state_.pc = 0xCFDD;
    ...
    // CFF5: BCC $01DE
    if (!cpu.carry_flag()) cpu.state_.pc = 0xD1D5;
    ...
    // D003: BCC $01EC
    if (!cpu.carry_flag()) cpu.state_.pc = 0xD1F1;
