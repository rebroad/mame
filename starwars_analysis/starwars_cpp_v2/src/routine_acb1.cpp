...
void routine_acb1_impl(StarWarsCPU& cpu) {
    ...
    // AD7B: BMI $00CE
    if (cpu.negative_flag()) cpu.state_.pc += 0x00CE;
    ...
    // ADFD: BPL $0152
    if (!cpu.negative_flag()) cpu.state_.pc += 0x0152;
