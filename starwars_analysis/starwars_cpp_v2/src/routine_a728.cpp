...
void routine_a728_impl(StarWarsCPU& cpu) {
    ...
    // A78A: BPL $0068
    if (!cpu.negative_flag()) cpu.state_.pc += 0x0068;
    ...
    // A792: BPL $006D
    if (!cpu.negative_flag()) cpu.state_.pc += 0x006D;
    ...
    // A857: BCC $0138
    if (!cpu.carry_flag()) cpu.state_.pc += 0x0138;
