...
void routine_bdfd_impl(CPU6809& cpu) {
    ...
    // BE28: BCS $0025
    if (cpu.carry_flag()) cpu.m_pc = 0xBE4F;
    ...
    // BE52: BPL $004F
    if (!cpu.negative_flag()) cpu.m_pc = 0xBEA3;
    ...
    // BF4C: BEQ $017F
    if (cpu.zero_flag()) cpu.m_pc = 0xBFCD;
    ...
    // BF77: BCS $017F
    if (cpu.carry_flag()) cpu.m_pc = 0xBFF8;
    ...
    // BFA3: BEQ $01B7
    if (cpu.zero_flag()) cpu.m_pc = 0xBF5C;
    ...
    // BFED: BCS $01F7
    if (cpu.carry_flag()) cpu.m_pc = 0xBFE6;
