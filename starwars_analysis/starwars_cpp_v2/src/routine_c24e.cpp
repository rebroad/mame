...
void routine_c24e_impl(StarWarsCPU& cpu) {
    ...
    // C282: BNE $004D
    if (!cpu.zero_flag()) cpu.state_.pc += 0x004D;
    ...
    // C34C: BEQ $012E
    if (cpu.zero_flag()) cpu.state_.pc += 0x012E;
    ...
    // C3A5: BEQ $0178
    if (cpu.zero_flag()) cpu.state_.pc += 0x0178;
    ...
    // C410: BCS $01BB
    if (cpu.carry_flag()) cpu.state_.pc += 0x01BB;
    ...
    // C43F: BCS $01E6
    if (cpu.carry_flag()) cpu.state_.pc += 0x01E6;
