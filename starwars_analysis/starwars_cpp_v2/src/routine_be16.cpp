...
void routine_be16_impl(CPU6809& cpu) {
    ...
    // BE28: BCS $000C
    if (cpu.carry_flag()) cpu.m_pc = 0xBE36;
    ...
    // BE52: BPL $0036
    if (!cpu.negative_flag()) cpu.m_pc = 0xBE8A;
    ...
    // BE5F: BCS $0024
    if (cpu.carry_flag()) cpu.m_pc = 0xBE85;
    ...
    // BF64: BCS $0153
    if (cpu.carry_flag()) cpu.m_pc = 0xBFB9;
    ...
    // BF77: BCS $0166
    if (cpu.carry_flag()) cpu.m_pc = 0xBFDF;
    ...
    // BFA3: BEQ $019E
    if (cpu.zero_flag()) cpu.m_pc = 0xBF43;
