...
void routine_ccfc_impl(StarWarsCPU& cpu) {
    // Converted from rom_disasm_ccfc.md
    // Address: 0xCCFC
    ...
    // CDC0: BMI $00C1
    if (cpu.negative_flag()) cpu.state_.pc = 0xCD83;
    ...
    // CE5A: BRA $01A7
    cpu.state_.pc = 0xCE03;

    // CE5E: BRA $01BB
    cpu.state_.pc = 0xCE1B;
    ...
    // CED3: BRA $020A
    cpu.state_.pc = 0xCEDF;

    // CED6: XANDCC #$33
    // TODO: Convert XANDCC #$33

    // CED8: BRA $021F
    cpu.state_.pc = 0xCEF9;
