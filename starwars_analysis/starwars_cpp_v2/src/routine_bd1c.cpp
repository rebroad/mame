...
void routine_bd1c_impl(StarWarsCPU& cpu) {
    // Converted from rom_disasm_bd1c.md
    // Address: 0xBD1C
    ...
    // BE28: BCS $0106
    if (cpu.carry_flag()) cpu.state_.pc = 0xBF30;
    ...
    // BE52: BPL $0130
    if (!cpu.negative_flag()) cpu.state_.pc = 0xBF84;
    ...
    // BE5F: BCS $011E
    if (cpu.carry_flag()) cpu.state_.pc = 0xBF7F;
