...
void routine_e7dd_impl(StarWarsCPU& cpu) {
    ...
    // E833: BCS $005F
    if (cpu.carry_flag()) cpu.state_.pc = 0xE894;
    ...
    // E83E: BNE $0068
    if (!cpu.zero_flag()) cpu.state_.pc = 0xE8A8;
    ...
    // E847: BNE $0072
    if (!cpu.zero_flag()) cpu.state_.pc = 0xE8BB;
    ...
    // E851: BCS $007B
    if (cpu.carry_flag()) cpu.state_.pc = 0xE8CE;
    ...
    // E891: BPL $004E
    if (!cpu.negative_flag()) cpu.state_.pc = 0xE8E1;
