...
void routine_e7dd_impl(CPU6809& cpu) {
    ...
    // E833: BCS $005F
    if (cpu.carry_flag()) cpu.m_pc = 0xE894;
    ...
    // E83E: BNE $0068
    if (!cpu.zero_flag()) cpu.m_pc = 0xE8A8;
    ...
    // E847: BNE $0072
    if (!cpu.zero_flag()) cpu.m_pc = 0xE8BB;
    ...
    // E851: BCS $007B
    if (cpu.carry_flag()) cpu.m_pc = 0xE8CE;
    ...
    // E85A: BNE $0084
    if (!cpu.zero_flag()) cpu.m_pc = 0xE7E0;
    ...
    // E863: BNE $008D
    if (!cpu.zero_flag()) cpu.m_pc = 0xE7F2;
    ...
    // E86C: BNE $0096
    if (!cpu.zero_flag()) cpu.m_pc = 0xE804;
    ...
    // E875: BNE $009F
    if (!cpu.zero_flag()) cpu.m_pc = 0xE816;
    ...
    // E87E: BNE $00A8
    if (!cpu.zero_flag()) cpu.m_pc = 0xE828;
    ...
    // E891: BPL $004E
    if (!cpu.negative_flag()) cpu.m_pc = 0xE8E1;
    ...
    // E947: BNE $014E
    if (!cpu.zero_flag()) cpu.m_pc = 0xE997;
