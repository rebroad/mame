...
void routine_e7dd_impl(StarWarsCPU& cpu) {
    // Converted from rom_disasm_e7dd.md
    // Address: 0xE7DD
    ...
    // E851: BCS $007B
    if (cpu.carry_flag()) cpu.state_.pc += 0x007B;
    ...
    // E85A: BNE $0084
    if (!cpu.zero_flag()) cpu.state_.pc += 0x0084;
    ...
    // E86C: BNE $0096
    if (!cpu.zero_flag()) cpu.state_.pc += 0x0096;
    ...
    // E891: BPL $004E
    if (!cpu.negative_flag()) cpu.state_.pc += 0x004E;
    ...
    // E945: BRA $014C
    cpu.state_.pc += 0x014C;

    // E947: BNE $014E
    if (!cpu.zero_flag()) cpu.state_.pc += 0x014E;
    ...
    // E970: ADDD $0179,PCR
    // TODO: Fix comma operator: ADDD $0179,PCR
    ...
    // E97A: ADDD [$0183,PCR]
    // TODO: Complex indexed addressing: [$0183,PCR]
    ...
    // E9D2: ANDB $E6AF,PCR
    // TODO: Fix comma operator: ANDB $E6AF,PCR
