...
void routine_b95c_impl(CPU6809& cpu) {
    ...
    // B990: BEQ $0045
    if (cpu.zero_flag()) cpu.m_pc = 0xB9D7;
    ...
    // B998: BCS $003F
    if (cpu.carry_flag()) cpu.m_pc = 0xB9D9;
    ...
    // B9A6: BCS $0032
    if (cpu.carry_flag()) cpu.m_pc = 0xB9DA;
    ...
    // B9EA: BGE $0093
    if (cpu.negative_flag() == cpu.overflow_flag()) cpu.m_pc = 0xB97F;
    ...
    // BA23: BEQ $00CC
    if (cpu.zero_flag()) cpu.m_pc = 0xB9F1;
    ...
    // BA2F: BCS $00C3
    if (cpu.carry_flag()) cpu.m_pc = 0xB9F4;
    ...
    // BA4F: BMI $0141
    if (cpu.negative_flag()) cpu.m_pc = 0xBA92;
    ...
    // BA5D: BPL $0107
    if (!cpu.negative_flag()) cpu.m_pc = 0xBA66;
    ...
    // BA66: BGE $0141
    if (cpu.negative_flag() == cpu.overflow_flag()) cpu.m_pc = 0xBAA9;
    ...
    // BA6E: BPL $0118
    if (!cpu.negative_flag()) cpu.m_pc = 0xBA88;
    ...
    // BA79: BGE $0141
    if (cpu.negative_flag() == cpu.overflow_flag()) cpu.m_pc = 0xBABC;
    ...
    // BA7F: BCS $0126
    if (cpu.carry_flag()) cpu.m_pc = 0xBAA7;
