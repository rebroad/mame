...
void routine_a40a_impl(StarWarsCPU& cpu) {
    ...
    // A4EF: BMI $0140
    if (cpu.negative_flag()) cpu.state_.pc += 0x0140;

    // A4F1: SUBD $5004
    cpu.state_.d -= 0x5004;

    // A4F4: BGT $0140
    // TODO: Convert BGT $0140
    ...
    // A602: BPL $01FD
    if (!cpu.negative_flag()) cpu.state_.pc += 0x01FD;
