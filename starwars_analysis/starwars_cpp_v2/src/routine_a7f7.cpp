...
void routine_a7f7_impl(StarWarsCPU& cpu) {
    ...
    // A93F: BMI $014E
    if (cpu.negative_flag()) cpu.state_.pc += 0x014E;
    ...
    // A966: BMI $0181
    if (cpu.negative_flag()) cpu.state_.pc += 0x0181;
