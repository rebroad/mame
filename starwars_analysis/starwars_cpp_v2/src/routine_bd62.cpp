...
void routine_bd62_impl(StarWarsCPU& cpu) {
    ...
    // BE28: BCS $00C0
    if (cpu.carry_flag()) cpu.state_.pc = 0xBDEA;
    ...
    // BE52: BPL $00EA
    if (!cpu.negative_flag()) cpu.state_.pc = 0xBE3E;
    ...
    // BE5F: BCS $00D8
    if (cpu.carry_flag()) cpu.state_.pc = 0xBE39;
    ...
    // BF4C: BEQ $021A
    if (cpu.zero_flag()) cpu.state_.pc = 0xBF68;
