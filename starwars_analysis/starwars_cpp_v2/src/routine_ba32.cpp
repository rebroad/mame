...
void routine_ba32_impl(StarWarsCPU& cpu) {
    ...
    // BAA2: BRA $008C
    cpu.state_.pc = 0xBA30;

    // BAA4: LDA #$15
    cpu.state_.a = 0x15;

    // BAA6: BRA $008C
    cpu.state_.pc = 0xBA34;

    // BAA8: LDA #$16
    cpu.state_.a = 0x16;

    // BAAA: BRA $008C
    cpu.state_.pc = 0xBA38;

    // BAAC: LDA #$11
    cpu.state_.a = 0x11;

    // BAAE: BRA $0086
    cpu.state_.pc = 0xBA36;

    // BAB0: LDA #$12
    cpu.state_.a = 0x12;

    // BAB2: BRA $0086
    cpu.state_.pc = 0xBA3A;

    // BAB4: LDA #$13
    cpu.state_.a = 0x13;

    // BAB6: BRA $0086
    cpu.state_.pc = 0xBA3E;
    ...
    // BBAE: BCC $0188
    if (!cpu.carry_flag()) cpu.state_.pc = 0xBB38;
    ...
    // BBD1: BCC $01D9
    if (!cpu.carry_flag()) cpu.state_.pc = 0xBBAC;
    ...
    // BBEA: BMI $01BD
    if (cpu.negative_flag()) cpu.state_.pc = 0xBBA9;
    ...
    // BBF3: BMI $01C6
    if (cpu.negative_flag()) cpu.state_.pc = 0xBBBB;
