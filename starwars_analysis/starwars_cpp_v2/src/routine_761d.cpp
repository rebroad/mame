...
void routine_761d_impl(StarWarsCPU& cpu) {
    ...
    // 7643: BEQ $0051
    if (cpu.zero_flag()) cpu.state_.pc += 0x0051;
    ...
    // 77B3: BPL $019C
    if (!cpu.negative_flag()) cpu.state_.pc += 0x019C;
