...
void routine_b261_impl(StarWarsCPU& cpu) {
    ...
    // B263: BNE $0005
    if (!cpu.zero_flag()) cpu.state_.pc += 0x0005;
    ...
    // B275: BLT $003A
    // TODO: Convert BLT $003A

    // B277: SUBD #$0480
    cpu.state_.d -= 0x0480;

    // B27A: BGT $003A
    // TODO: Convert BGT $003A
    ...
    // B2D8: BMI $0080
    if (cpu.negative_flag()) cpu.state_.pc += 0x0080;
    ...
    // B2FA: BMI $00A6
    if (cpu.negative_flag()) cpu.state_.pc += 0x00A6;
