...
void routine_cd9e_impl(StarWarsCPU& cpu) {
    // Converted from rom_disasm_cd9e.md
    // Address: 0xCD9E
    ...
    // CDC0: BMI $001F
    if (cpu.negative_flag()) cpu.state_.pc = 0xCDE1;
    ...
    // CE5A: BRA $0105
    cpu.state_.pc = 0xCE61;

    // CE5E: BRA $0119
    cpu.state_.pc = 0xCE79;
    ...
    // CED3: BRA $0168
    cpu.state_.pc = 0xCF3D;

    // CED6: XANDCC #$33
    // TODO: Convert XANDCC #$33

    // CED8: BRA $017D
    cpu.state_.pc = 0xCF57;
