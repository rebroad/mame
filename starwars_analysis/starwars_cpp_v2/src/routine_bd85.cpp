...
void routine_bd85_impl(StarWarsCPU& cpu) {
    ...
    // BE28: BCS $009D
    if (cpu.carry_flag()) cpu.state_.pc = 0xBEC7;
    ...
    // BE52: BPL $00C7
    if (!cpu.negative_flag()) cpu.state_.pc = 0xBF1B;
    ...
    // BF4C: BEQ $01F7
    if (cpu.zero_flag()) cpu.state_.pc = 0xC145;
    ...
    // BF64: BCS $01E4
    if (cpu.carry_flag()) cpu.state_.pc = 0xC14A;
    ...
    // BF77: BCS $01F7
    if (cpu.carry_flag()) cpu.state_.pc = 0xC170;
