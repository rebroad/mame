...
void routine_bd85_impl(StarWarsCPU& cpu) {
    // Converted from rom_disasm_bd85.md
    // Address: 0xBD85
    ...
    // BE28: BCS $009D
    if (cpu.carry_flag()) cpu.state_.pc = 0xBDC7;
    ...
    // BE52: BPL $00C7
    if (!cpu.negative_flag()) cpu.state_.pc = 0xBE1B;
    ...
    // BE5F: BCS $00B5
    if (cpu.carry_flag()) cpu.state_.pc = 0xBE16;
    ...
    // BF4C: BEQ $01F7
    if (cpu.zero_flag()) cpu.state_.pc = 0xBF45;
    ...
    // BF64: BCS $01E4
    if (cpu.carry_flag()) cpu.state_.pc = 0xBF4A;
    ...
    // BF77: BCS $01F7
    if (cpu.carry_flag()) cpu.state_.pc = 0xBF70;
