...
void routine_cd50_impl(StarWarsCPU& cpu) {
    // Converted from rom_disasm_cd50.md
    // Address: 0xCD50
    ...
    // CDC0: BMI $006D
    if (cpu.negative_flag()) cpu.state_.pc = 0xCE2F;
    ...
    // CE5A: BRA $0153
    cpu.state_.pc = 0xCEAF;

    // CE5E: BRA $0167
    cpu.state_.pc = 0xCEC7;
    ...
    // CED3: BRA $01B6
    cpu.state_.pc = 0xCE8B;

    // CED6: XANDCC #$33
    // TODO: Convert XANDCC #$33

    // CED8: BRA $01CB
    cpu.state_.pc = 0xCEA5;
