...
void routine_bd94_impl(StarWarsCPU& cpu) {
    ...
    // BE28: BCS $008E
    if (cpu.carry_flag()) cpu.state_.pc = 0xBDB8;
    ...
    // BE52: BPL $00B8
    if (!cpu.negative_flag()) cpu.state_.pc = 0xBE0C;
    ...
    // BE5F: BCS $00A6
    if (cpu.carry_flag()) cpu.state_.pc = 0xBE07;
    ...
    // BF4C: BEQ $01E8
    if (cpu.zero_flag()) cpu.state_.pc = 0xBF36;
    ...
    // BF64: BCS $01D5
    if (cpu.carry_flag()) cpu.state_.pc = 0xBF3B;
    ...
    // BF77: BCS $01E8
    if (cpu.carry_flag()) cpu.state_.pc = 0xBF61;
