...
void routine_97c2_impl(CPU6809& cpu) {
    ...
    // 9892: BEQ $00D5
    if (cpu.zero_flag()) cpu.m_pc = 0x9869;
    ...
    // 989C: BNE $00ED
    if (!cpu.zero_flag()) cpu.m_pc = 0x988B;
    ...
    // 98A3: BPL $00E5
    if (!cpu.negative_flag()) cpu.m_pc = 0x988A;
    ...
    // 98AD: BCS $00DF
    if (cpu.carry_flag()) cpu.m_pc = 0x988E;
    ...
    // 98B4: BEQ $0108
    if (cpu.zero_flag()) cpu.m_pc = 0x98BE;
    ...
    // 98DA: BCS $013F
    if (cpu.carry_flag()) cpu.m_pc = 0x991B;
