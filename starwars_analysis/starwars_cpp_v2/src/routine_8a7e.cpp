...
void routine_8a7e_impl(StarWarsCPU& cpu) {
    ...
    // 8BDE: BCS $010B
    if (cpu.carry_flag()) cpu.state_.pc += 0x010B;
    ...
    // 8C31: BCC $01B8
    if (!cpu.carry_flag()) cpu.state_.pc += 0x01B8;
    ...
    // 8C3F: BCC $01C6
    if (!cpu.carry_flag()) cpu.state_.pc += 0x01C6;
