...
void routine_7863_impl(StarWarsCPU& cpu) {
    ...
    // 7963: BPL $0107
    if (!cpu.negative_flag()) cpu.state_.pc += 0x0107;
    ...
    // 7991: BPL $0134
    if (!cpu.negative_flag()) cpu.state_.pc += 0x0134;
