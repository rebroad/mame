...
void routine_bd08_impl(StarWarsCPU& cpu) {
    // Converted from rom_disasm_bd08.md
    // Address: 0xBD08
    ...
    // BE28: BCS $011A
    if (cpu.carry_flag()) cpu.state_.pc = 0xBF44;
    ...
    // BE52: BPL $0144
    if (!cpu.negative_flag()) cpu.state_.pc = 0xBF98;
    ...
    // BE5F: BCS $0132
    if (cpu.carry_flag()) cpu.state_.pc = 0xBF93;
