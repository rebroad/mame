...
void routine_afef_impl(StarWarsCPU& cpu) {
    ...
    // B124: BCS $0139
    if (cpu.carry_flag()) cpu.state_.pc += 0x0139;
    ...
    // B13E: BLT $0168
    // TODO: Convert BLT $0168

    // B140: SUBD #$0400
    cpu.state_.d -= 0x0400;

    // B143: BGT $0168
    // TODO: Convert BGT $0168
