...
void routine_bdb2_impl(StarWarsCPU& cpu) {
    ...
    // BE52: BPL $009A
    if (!cpu.negative_flag()) cpu.state_.pc = 0xBEEE;
    ...
    // BE5F: BCS $0088
    if (cpu.carry_flag()) cpu.state_.pc = 0xBEE9;
    ...
    // BF4C: BEQ $01CA
    if (cpu.zero_flag()) cpu.state_.pc = 0xC118;
    ...
    // BF64: BCS $01B7
    if (cpu.carry_flag()) cpu.state_.pc = 0xC11D;
    ...
    // BF77: BCS $01CA
    if (cpu.carry_flag()) cpu.state_.pc = 0xC143;
    ...
    // BFA3: BEQ $0202
    if (cpu.zero_flag()) cpu.state_.pc = 0xC1A7;
