...
void routine_bdb2_impl(StarWarsCPU& cpu) {
    // Converted from rom_disasm_bdb2.md
    // Address: 0xBDB2
    ...
    // BE28: BCS $0070
    if (cpu.carry_flag()) cpu.state_.pc = 0xBE9A;
    ...
    // BE52: BPL $009A
    if (!cpu.negative_flag()) cpu.state_.pc = 0xBDEE;
    ...
    // BE5F: BCS $0088
    if (cpu.carry_flag()) cpu.state_.pc = 0xBDE9;
    ...
    // BF4C: BEQ $01CA
    if (cpu.zero_flag()) cpu.state_.pc = 0xBF18;
    ...
    // BF64: BCS $01B7
    if (cpu.carry_flag()) cpu.state_.pc = 0xBF1D;
    ...
    // BF77: BCS $01CA
    if (cpu.carry_flag()) cpu.state_.pc = 0xBF43;
    ...
    // BFA3: BEQ $0202
    if (cpu.zero_flag()) cpu.state_.pc = 0xBFA7;
