...
void routine_bdb2_impl(CPU6809& cpu) {
    ...
    // BE28: BCS $0070
    if (cpu.carry_flag()) cpu.m_pc = 0xBE9A;
    ...
    // BE52: BPL $009A
    if (!cpu.negative_flag()) cpu.m_pc = 0xBDEE;
    ...
    // BE5F: BCS $0088
    if (cpu.carry_flag()) cpu.m_pc = 0xBDE9;
    ...
    // BF4C: BEQ $01CA
    if (cpu.zero_flag()) cpu.m_pc = 0xBF18;
    ...
    // BF64: BCS $01B7
    if (cpu.carry_flag()) cpu.m_pc = 0xBF1D;
    ...
    // BF77: BCS $01CA
    if (cpu.carry_flag()) cpu.m_pc = 0xBF43;
    ...
    // BFA3: BEQ $0202
    if (cpu.zero_flag()) cpu.m_pc = 0xBFA7;
