...
void routine_8981_impl(CPU6809& cpu) {
    // Converted from rom_disasm_8981.md
    // Address: 0x8981
    ...
    // 8AD5: BNE $015A
    if (!cpu.zero_flag()) cpu.m_pc = 0x8B31;
    ...
    // 8AE3: BNE $016C
    if (!cpu.zero_flag()) cpu.m_pc = 0x8B51;
    ...
    // 8B30: BCS $01B2
    if (cpu.carry_flag()) cpu.m_pc = 0x8AE4;
    ...
    // 8B42: BCS $01C4
    if (cpu.carry_flag()) cpu.m_pc = 0x8B08;
    ...
    // 8B51: BPL $0197
    if (!cpu.negative_flag()) cpu.m_pc = 0x8AEA;
    ...
    // 8B76: BEQ $01FA
    if (cpu.zero_flag()) cpu.m_pc = 0x8B72;
