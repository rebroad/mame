...
void routine_f17f_impl(StarWarsCPU& cpu) {
    ...
    // F219: BCC $009E
    if (!cpu.carry_flag()) cpu.state_.pc += 0x009E;
    ...
    // F28A: BNE $0102
    if (!cpu.zero_flag()) cpu.state_.pc += 0x0102;
    ...
    // F303: BCS $017C
    if (cpu.carry_flag()) cpu.state_.pc += 0x017C;
