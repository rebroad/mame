...
void routine_aebd_impl(StarWarsCPU& cpu) {
    ...
    // AEC1: BNE $0007
    if (!cpu.zero_flag()) cpu.state_.pc += 0x0007;
    ...
    // AFD8: BLT $00E0
    // TODO: Convert BLT $00E0

    // AFDA: SUBD #$0010
    cpu.state_.d -= 0x0010;

    // AFDD: BGT $00E0
    // TODO: Convert BGT $00E0
    ...
    // B03D: BEQ $0187
    if (cpu.zero_flag()) cpu.state_.pc += 0x0187;
    ...
    // B080: BMI $01CC
    if (cpu.negative_flag()) cpu.state_.pc += 0x01CC;
