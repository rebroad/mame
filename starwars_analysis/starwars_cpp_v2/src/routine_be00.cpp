...
void routine_be00_impl(CPU6809& cpu) {
    ...
    // BE00: CMPX $E986
    cpu.compare_x(cpu.read_memory16(0xE986));
    ...
    // BE28: BCS $0022
    if (cpu.carry_flag()) cpu.m_pc = 0xBE4C;
    ...
    // BE52: BPL $004C
    if (!cpu.negative_flag()) cpu.m_pc = 0xBEA0;
    ...
    // BE5F: BCS $003A
    if (cpu.carry_flag()) cpu.m_pc = 0xBE9B;
    ...
    // BF4C: BEQ $017C
    if (cpu.zero_flag()) cpu.m_pc = 0xBFCA;
    ...
    // BF64: BCS $0169
    if (cpu.carry_flag()) cpu.m_pc = 0xBFCF;
    ...
    // BF77: BCS $017C
    if (cpu.carry_flag()) cpu.m_pc = 0xBFF5;
    ...
    // BFA3: BEQ $01B4
    if (cpu.zero_flag()) cpu.m_pc = 0xBF59;
    ...
    // BFED: BCS $01F4
    if (cpu.carry_flag()) cpu.m_pc = 0xBFE3;
