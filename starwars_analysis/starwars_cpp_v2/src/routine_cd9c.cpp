...
void routine_cd9c_impl(StarWarsCPU& cpu) {
    // Converted from rom_disasm_cd9c.md
    // Address: 0xCD9C
    ...
    // CDC0: BMI $0021
    if (cpu.negative_flag()) cpu.state_.pc = 0xCDE3;
    ...
    // CE5A: BRA $0107
    cpu.state_.pc = 0xCF63;

    // CE5E: BRA $011B
    cpu.state_.pc = 0xCF7B;
    ...
    // CED3: BRA $016A
    cpu.state_.pc = 0xD03F;

    // CED6: XANDCC #$33
    // TODO: Convert XANDCC #$33

    // CED8: BRA $017F
    cpu.state_.pc = 0xD059;
