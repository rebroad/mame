...
void routine_97e8_impl(CPU6809& cpu) {
    ...
    // 9876: BNE $0096
    if (!cpu.zero_flag()) cpu.m_pc = 0x980E;
    ...
    // 9892: BEQ $00AF
    if (cpu.zero_flag()) cpu.m_pc = 0x9843;
    ...
    // 989C: BNE $00C7
    if (!cpu.zero_flag()) cpu.m_pc = 0x9865;
    ...
    // 98A3: BPL $00BF
    if (!cpu.negative_flag()) cpu.m_pc = 0x9864;
    ...
    // 98B4: BEQ $00E2
    if (cpu.zero_flag()) cpu.m_pc = 0x9898;
    ...
    // 98D8: BCC $0116
    if (!cpu.carry_flag()) cpu.m_pc = 0x98F0;
