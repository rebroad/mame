...
void routine_ce45_impl(StarWarsCPU& cpu) {
    // Converted from rom_disasm_ce45.md
    // Address: 0xCE45
    ...
    // CED3: BRA $00C1
    cpu.state_.pc = 0xCE96;

    // CED6: XANDCC #$33
    // TODO: Convert XANDCC #$33

    // CED8: BRA $00D6
    cpu.state_.pc = 0xCEB0;
    ...
    // CFF5: BCC $01B1
    if (!cpu.carry_flag()) cpu.state_.pc = 0xCFA8;
    ...
    // CFFE: SUBB $0177,PCR
    // TODO: Fix comma operator: SUBB $0177,PCR

    // D001: ORA <$1F
    cpu.state_.a |= 0x1F;

    // D003: BCC $01BF
    if (!cpu.carry_flag()) cpu.state_.pc = 0xCFC4;
    ...
    // D00C: SUBB $0185,PCR
    // TODO: Fix comma operator: SUBB $0185,PCR
    ...
    // D03B: CMPX $1FB0
    cpu.compare_x(cpu.read_memory_word(0x1FB0));
