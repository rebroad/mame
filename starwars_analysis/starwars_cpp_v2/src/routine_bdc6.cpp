...
void routine_bdc6_impl(CPU6809& cpu) {
    ...
    // BE28: BCS $005C
    if (cpu.carry_flag()) cpu.m_pc = 0xBE86;
    ...
    // BE52: BPL $0086
    if (!cpu.negative_flag()) cpu.m_pc = 0xBDDA;
    ...
    // BE5F: BCS $0074
    if (cpu.carry_flag()) cpu.m_pc = 0xBED5;
    ...
    // BF4C: BEQ $01B6
    if (cpu.zero_flag()) cpu.m_pc = 0xBF04;
    ...
    // BF64: BCS $01A3
    if (cpu.carry_flag()) cpu.m_pc = 0xBF09;
    ...
    // BF77: BCS $01B6
    if (cpu.carry_flag()) cpu.m_pc = 0xBF2F;
    ...
    // BFA3: BEQ $01EE
    if (cpu.zero_flag()) cpu.m_pc = 0xBF93;
