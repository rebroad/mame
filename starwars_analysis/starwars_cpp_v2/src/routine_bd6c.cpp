...
void routine_bd6c_impl(CPU6809& cpu) {
    ...
    // BE28: BCS $00B6
    if (cpu.carry_flag()) cpu.m_pc = 0xBDE0;
    ...
    // BE52: BPL $00E0
    if (!cpu.negative_flag()) cpu.m_pc = 0xBE34;
    ...
    // BE5F: BCS $00CE
    if (cpu.carry_flag()) cpu.m_pc = 0xBE2F;
    ...
    // BF4C: BEQ $0210
    if (cpu.zero_flag()) cpu.m_pc = 0xBF5E;
    ...
    // BF64: BCS $01FD
    if (cpu.carry_flag()) cpu.m_pc = 0xBF63;
