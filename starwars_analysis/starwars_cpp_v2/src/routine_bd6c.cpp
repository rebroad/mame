...
void routine_bd6c_impl(StarWarsCPU& cpu) {
    ...
    // BE28: BCS $00B6
    if (cpu.carry_flag()) cpu.state_.pc = 0xBEE0;
    ...
    // BE52: BPL $00E0
    if (!cpu.negative_flag()) cpu.state_.pc = 0xBF34;
    ...
    // BF4C: BEQ $0210
    if (cpu.zero_flag()) cpu.state_.pc = 0xC15E;
    ...
    // BF64: BCS $01FD
    if (cpu.carry_flag()) cpu.state_.pc = 0xC163;
