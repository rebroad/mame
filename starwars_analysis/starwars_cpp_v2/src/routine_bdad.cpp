...
void routine_bdad_impl(CPU6809& cpu) {
    ...
    // BE28: BCS $0075
    if (cpu.carry_flag()) cpu.m_pc = 0xBE9F;
    ...
    // BE52: BPL $009F
    if (!cpu.negative_flag()) cpu.m_pc = 0xBDF3;
    ...
    // BE5F: BCS $008D
    if (cpu.carry_flag()) cpu.m_pc = 0xBDEE;
    ...
    // BF4C: BEQ $01CF
    if (cpu.zero_flag()) cpu.m_pc = 0xBF1D;
    ...
    // BF64: BCS $01BC
    if (cpu.carry_flag()) cpu.m_pc = 0xBF22;
    ...
    // BF77: BCS $01CF
    if (cpu.carry_flag()) cpu.m_pc = 0xBF48;
    ...
    // BFA3: BEQ $0207
    if (cpu.zero_flag()) cpu.m_pc = 0xBFAC;
