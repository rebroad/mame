...
void routine_ce2f_impl(StarWarsCPU& cpu) {
    // Converted from rom_disasm_ce2f.md
    // Address: 0xCE2F
    ...
    // CE5A: BRA $0074
    cpu.state_.pc = 0xCED0;

    // CE5E: BRA $0088
    cpu.state_.pc = 0xCDE8;
    ...
    // CED3: BRA $00D7
    cpu.state_.pc = 0xCEAC;

    // CED6: XANDCC #$33
    // TODO: Convert XANDCC #$33

    // CED8: BRA $00EC
    cpu.state_.pc = 0xCEC6;
    ...
    // CFF5: BCC $01C7
    if (!cpu.carry_flag()) cpu.state_.pc = 0xCFBE;
    ...
    // CFFE: SUBB $018D,PCR
    // TODO: Fix comma operator: SUBB $018D,PCR

    // D001: ORA <$1F
    cpu.state_.a |= 0x1F;

    // D003: BCC $01D5
    if (!cpu.carry_flag()) cpu.state_.pc = 0xCFDA;
    ...
    // D00C: SUBB $019B,PCR
    // TODO: Fix comma operator: SUBB $019B,PCR
