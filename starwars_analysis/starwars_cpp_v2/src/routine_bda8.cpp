...
void routine_bda8_impl(StarWarsCPU& cpu) {
    ...
    // BE52: BPL $00A4
    if (!cpu.negative_flag()) cpu.state_.pc = 0xBDF8;
    ...
    // BE5F: BCS $0092
    if (cpu.carry_flag()) cpu.state_.pc = 0xBDF3;
    ...
    // BF4C: BEQ $01D4
    if (cpu.zero_flag()) cpu.state_.pc = 0xBF22;
    ...
    // BF64: BCS $01C1
    if (cpu.carry_flag()) cpu.state_.pc = 0xBF27;
    ...
    // BF77: BCS $01D4
    if (cpu.carry_flag()) cpu.state_.pc = 0xBF4D;
    ...
    // BFA3: BEQ $020C
    if (cpu.zero_flag()) cpu.state_.pc = 0xBFB1;
