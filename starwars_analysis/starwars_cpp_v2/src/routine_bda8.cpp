...
void routine_bda8_impl(StarWarsCPU& cpu) {
    // Converted from rom_disasm_bda8.md
    // Address: 0xBDA8
    ...
    // BE28: BCS $007A
    if (cpu.carry_flag()) cpu.state_.pc = 0xBEA4;
    ...
    // BE52: BPL $00A4
    if (!cpu.negative_flag()) cpu.state_.pc = 0xBEF8;
    ...
    // BE5F: BCS $0092
    if (cpu.carry_flag()) cpu.state_.pc = 0xBEF3;
    ...
    // BF4C: BEQ $01D4
    if (cpu.zero_flag()) cpu.state_.pc = 0xC122;
    ...
    // BF64: BCS $01C1
    if (cpu.carry_flag()) cpu.state_.pc = 0xC127;
    ...
    // BF77: BCS $01D4
    if (cpu.carry_flag()) cpu.state_.pc = 0xC14D;
    ...
    // BFA3: BEQ $020C
    if (cpu.zero_flag()) cpu.state_.pc = 0xC1B1;
