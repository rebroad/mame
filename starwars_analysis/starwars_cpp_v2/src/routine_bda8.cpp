...
void routine_bda8_impl(CPU6809& cpu) {
    ...
    // BE28: BCS $007A
    if (cpu.carry_flag()) cpu.m_pc = 0xBEA4;
    ...
    // BE52: BPL $00A4
    if (!cpu.negative_flag()) cpu.m_pc = 0xBDF8;
    ...
    // BE5F: BCS $0092
    if (cpu.carry_flag()) cpu.m_pc = 0xBDF3;
    ...
    // BF4C: BEQ $01D4
    if (cpu.zero_flag()) cpu.m_pc = 0xBF22;
    ...
    // BF64: BCS $01C1
    if (cpu.carry_flag()) cpu.m_pc = 0xBF27;
    ...
    // BF77: BCS $01D4
    if (cpu.carry_flag()) cpu.m_pc = 0xBF4D;
    ...
    // BFA3: BEQ $020C
    if (cpu.zero_flag()) cpu.m_pc = 0xBFB1;
