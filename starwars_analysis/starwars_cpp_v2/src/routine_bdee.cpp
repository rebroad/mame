...
void routine_bdee_impl(CPU6809& cpu) {
    ...
    // BE28: BCS $0034
    if (cpu.carry_flag()) cpu.m_pc = 0xBE5E;
    ...
    // BE52: BPL $005E
    if (!cpu.negative_flag()) cpu.m_pc = 0xBEB2;
    ...
    // BE5F: BCS $004C
    if (cpu.carry_flag()) cpu.m_pc = 0xBEAD;
    ...
    // BF4C: BEQ $018E
    if (cpu.zero_flag()) cpu.m_pc = 0xBEDC;
    ...
    // BF77: BCS $018E
    if (cpu.carry_flag()) cpu.m_pc = 0xBF07;
    ...
    // BFA3: BEQ $01C6
    if (cpu.zero_flag()) cpu.m_pc = 0xBF6B;
    ...
    // BFED: BCS $0201
    if (cpu.carry_flag()) cpu.m_pc = 0xBFF0;
