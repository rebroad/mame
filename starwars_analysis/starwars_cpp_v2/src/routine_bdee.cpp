...
void routine_bdee_impl(StarWarsCPU& cpu) {
    ...
    // BF4C: BEQ $018E
    if (cpu.zero_flag()) cpu.state_.pc = 0xC0DC;
    ...
    // BF64: BCS $017B
    if (cpu.carry_flag()) cpu.state_.pc = 0xC0E1;
    ...
    // BF77: BCS $018E
    if (cpu.carry_flag()) cpu.state_.pc = 0xC107;
    ...
    // BFA3: BEQ $01C6
    if (cpu.zero_flag()) cpu.state_.pc = 0xC16B;
