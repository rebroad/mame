...
void routine_bdee_impl(StarWarsCPU& cpu) {
    // Converted from rom_disasm_bdee.md
    // Address: 0xBDEE
    ...
    // BE28: BCS $0034
    if (cpu.carry_flag()) cpu.state_.pc = 0xBE5E;
    ...
    // BE52: BPL $005E
    if (!cpu.negative_flag()) cpu.state_.pc = 0xBEB2;
    ...
    // BE5F: BCS $004C
    if (cpu.carry_flag()) cpu.state_.pc = 0xBEAD;
    ...
    // BF4C: BEQ $018E
    if (cpu.zero_flag()) cpu.state_.pc = 0xBEDC;
    ...
    // BF77: BCS $018E
    if (cpu.carry_flag()) cpu.state_.pc = 0xBF07;
    ...
    // BFA3: BEQ $01C6
    if (cpu.zero_flag()) cpu.state_.pc = 0xBF6B;
