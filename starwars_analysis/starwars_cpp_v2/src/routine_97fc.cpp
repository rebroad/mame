...
void routine_97fc_impl(CPU6809& cpu) {
    ...
    // 9876: BNE $0082
    if (!cpu.zero_flag()) cpu.m_pc = 0x97FA;
    ...
    // 9892: BEQ $009B
    if (cpu.zero_flag()) cpu.m_pc = 0x982F;
    ...
    // 989C: BNE $00B3
    if (!cpu.zero_flag()) cpu.m_pc = 0x9851;
    ...
    // 98A3: BPL $00AB
    if (!cpu.negative_flag()) cpu.m_pc = 0x9850;
    ...
    // 98AD: BCS $00A5
    if (cpu.carry_flag()) cpu.m_pc = 0x9854;
    ...
    // 98B4: BEQ $00CE
    if (cpu.zero_flag()) cpu.m_pc = 0x9884;
