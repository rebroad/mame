...
void routine_8495_impl(StarWarsCPU& cpu) {
    ...
    // 8552: BLT $00E3
    // TODO: Convert BLT $00E3

    // 8554: SUBD #$0400
    cpu.state_.d -= 0x0400;

    // 8557: BGE $00D0
    // TODO: Convert BGE $00D0
    ...
    // 85F3: BEQ $0163
    if (cpu.zero_flag()) cpu.state_.pc += 0x0163;
    ...
    // 8648: BPL $01B9
    if (!cpu.negative_flag()) cpu.state_.pc += 0x01B9;
