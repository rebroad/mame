...
void routine_bd03_impl(StarWarsCPU& cpu) {
    // Converted from rom_disasm_bd03.md
    // Address: 0xBD03
    ...
    // BE28: BCS $011F
    if (cpu.carry_flag()) cpu.state_.pc = 0xBF49;
    ...
    // BE52: BPL $0149
    if (!cpu.negative_flag()) cpu.state_.pc = 0xBF9D;
    ...
    // BE5F: BCS $0137
    if (cpu.carry_flag()) cpu.state_.pc = 0xBF98;
