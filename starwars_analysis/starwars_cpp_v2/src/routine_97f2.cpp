...
void routine_97f2_impl(CPU6809& cpu) {
    ...
    // 9876: BNE $008C
    if (!cpu.zero_flag()) cpu.m_pc = 0x9804;
    ...
    // 9892: BEQ $00A5
    if (cpu.zero_flag()) cpu.m_pc = 0x9839;
    ...
    // 989C: BNE $00BD
    if (!cpu.zero_flag()) cpu.m_pc = 0x985B;
    ...
    // 98A3: BPL $00B5
    if (!cpu.negative_flag()) cpu.m_pc = 0x985A;
    ...
    // 98B4: BEQ $00D8
    if (cpu.zero_flag()) cpu.m_pc = 0x988E;
    ...
    // 98DA: BCS $010F
    if (cpu.carry_flag()) cpu.m_pc = 0x98EB;
