...
void routine_bdbc_impl(StarWarsCPU& cpu) {
    // Converted from rom_disasm_bdbc.md
    // Address: 0xBDBC
    ...
    // BE28: BCS $0066
    if (cpu.carry_flag()) cpu.state_.pc = 0xBE90;
    ...
    // BE52: BPL $0090
    if (!cpu.negative_flag()) cpu.state_.pc = 0xBEE4;
    ...
    // BE5F: BCS $007E
    if (cpu.carry_flag()) cpu.state_.pc = 0xBEDF;
    ...
    // BF4C: BEQ $01C0
    if (cpu.zero_flag()) cpu.state_.pc = 0xC10E;
    ...
    // BF64: BCS $01AD
    if (cpu.carry_flag()) cpu.state_.pc = 0xC113;
    ...
    // BFA3: BEQ $01F8
    if (cpu.zero_flag()) cpu.state_.pc = 0xC19D;
