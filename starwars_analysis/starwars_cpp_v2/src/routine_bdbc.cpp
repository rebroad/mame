...
void routine_bdbc_impl(CPU6809& cpu) {
    ...
    // BE28: BCS $0066
    if (cpu.carry_flag()) cpu.m_pc = 0xBE90;
    ...
    // BE52: BPL $0090
    if (!cpu.negative_flag()) cpu.m_pc = 0xBDE4;
    ...
    // BE5F: BCS $007E
    if (cpu.carry_flag()) cpu.m_pc = 0xBEDF;
    ...
    // BF4C: BEQ $01C0
    if (cpu.zero_flag()) cpu.m_pc = 0xBF0E;
    ...
    // BF64: BCS $01AD
    if (cpu.carry_flag()) cpu.m_pc = 0xBF13;
    ...
    // BF77: BCS $01C0
    if (cpu.carry_flag()) cpu.m_pc = 0xBF39;
    ...
    // BFA3: BEQ $01F8
    if (cpu.zero_flag()) cpu.m_pc = 0xBF9D;
