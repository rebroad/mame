...
void routine_bd8a_impl(StarWarsCPU& cpu) {
    // Converted from rom_disasm_bd8a.md
    // Address: 0xBD8A
    ...
    // BE28: BCS $0098
    if (cpu.carry_flag()) cpu.state_.pc = 0xBEC2;
    ...
    // BE52: BPL $00C2
    if (!cpu.negative_flag()) cpu.state_.pc = 0xBF16;
    ...
    // BF4C: BEQ $01F2
    if (cpu.zero_flag()) cpu.state_.pc = 0xC140;
    ...
    // BF64: BCS $01DF
    if (cpu.carry_flag()) cpu.state_.pc = 0xC145;
    ...
    // BF77: BCS $01F2
    if (cpu.carry_flag()) cpu.state_.pc = 0xC16B;
