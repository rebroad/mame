...
void routine_bd8a_impl(StarWarsCPU& cpu) {
    ...
    // BE28: BCS $0098
    if (cpu.carry_flag()) cpu.state_.pc = 0xBDC2;
    ...
    // BE52: BPL $00C2
    if (!cpu.negative_flag()) cpu.state_.pc = 0xBE16;
    ...
    // BE5F: BCS $00B0
    if (cpu.carry_flag()) cpu.state_.pc = 0xBE11;
    ...
    // BF4C: BEQ $01F2
    if (cpu.zero_flag()) cpu.state_.pc = 0xBF40;
    ...
    // BF64: BCS $01DF
    if (cpu.carry_flag()) cpu.state_.pc = 0xBF45;
    ...
    // BF77: BCS $01F2
    if (cpu.carry_flag()) cpu.state_.pc = 0xBF6B;
