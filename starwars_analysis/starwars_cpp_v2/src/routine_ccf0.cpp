...
void routine_ccf0_impl(StarWarsCPU& cpu) {
    // Converted from rom_disasm_ccf0.md
    // Address: 0xCCF0
    ...
    // CDC0: BMI $00CD
    if (cpu.negative_flag()) cpu.state_.pc = 0xCE8F;
    ...
    // CE5A: BRA $01B3
    cpu.state_.pc = 0xD00F;

    // CE5E: BRA $01C7
    cpu.state_.pc = 0xD027;
    ...
    // CED3: BRA $0216
    cpu.state_.pc = 0xD0EB;

    // CED6: XANDCC #$33
    // TODO: Convert XANDCC #$33

    // CED8: BRA $022B
    cpu.state_.pc = 0xD105;
