...
void routine_bd99_impl(StarWarsCPU& cpu) {
    ...
    // BE28: BCS $0089
    if (cpu.carry_flag()) cpu.state_.pc = 0xBDB3;
    ...
    // BE52: BPL $00B3
    if (!cpu.negative_flag()) cpu.state_.pc = 0xBE07;
    ...
    // BE5F: BCS $00A1
    if (cpu.carry_flag()) cpu.state_.pc = 0xBE02;
    ...
    // BF4C: BEQ $01E3
    if (cpu.zero_flag()) cpu.state_.pc = 0xBF31;
    ...
    // BF64: BCS $01D0
    if (cpu.carry_flag()) cpu.state_.pc = 0xBF36;
    ...
    // BF77: BCS $01E3
    if (cpu.carry_flag()) cpu.state_.pc = 0xBF5C;
