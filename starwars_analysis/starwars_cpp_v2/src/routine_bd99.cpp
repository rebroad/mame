...
void routine_bd99_impl(StarWarsCPU& cpu) {
    // Converted from rom_disasm_bd99.md
    // Address: 0xBD99
    ...
    // BE28: BCS $0089
    if (cpu.carry_flag()) cpu.state_.pc = 0xBEB3;
    ...
    // BE52: BPL $00B3
    if (!cpu.negative_flag()) cpu.state_.pc = 0xBF07;
    ...
    // BF4C: BEQ $01E3
    if (cpu.zero_flag()) cpu.state_.pc = 0xC131;
    ...
    // BF64: BCS $01D0
    if (cpu.carry_flag()) cpu.state_.pc = 0xC136;
    ...
    // BF77: BCS $01E3
    if (cpu.carry_flag()) cpu.state_.pc = 0xC15C;
