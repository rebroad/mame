...
void routine_bd35_impl(StarWarsCPU& cpu) {
    // Converted from rom_disasm_bd35.md
    // Address: 0xBD35
    ...
    // BE28: BCS $00ED
    if (cpu.carry_flag()) cpu.state_.pc = 0xBF17;
    ...
    // BE52: BPL $0117
    if (!cpu.negative_flag()) cpu.state_.pc = 0xBF6B;
    ...
    // BE5F: BCS $0105
    if (cpu.carry_flag()) cpu.state_.pc = 0xBF66;
