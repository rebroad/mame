...
void routine_cd80_impl(StarWarsCPU& cpu) {
    // Converted from rom_disasm_cd80.md
    // Address: 0xCD80
    ...
    // CDC0: BMI $003D
    if (cpu.negative_flag()) cpu.state_.pc = 0xCDFF;
    ...
    // CE5A: BRA $0123
    cpu.state_.pc = 0xCF7F;

    // CE5E: BRA $0137
    cpu.state_.pc = 0xCF97;
    ...
    // CED3: BRA $0186
    cpu.state_.pc = 0xD05B;

    // CED6: XANDCC #$33
    // TODO: Convert XANDCC #$33

    // CED8: BRA $019B
    cpu.state_.pc = 0xD075;
