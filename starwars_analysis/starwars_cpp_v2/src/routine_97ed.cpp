...
void routine_97ed_impl(CPU6809& cpu) {
    ...
    // 9876: BNE $0091
    if (!cpu.zero_flag()) cpu.m_pc = 0x9809;
    ...
    // 9892: BEQ $00AA
    if (cpu.zero_flag()) cpu.m_pc = 0x983E;
    ...
    // 989C: BNE $00C2
    if (!cpu.zero_flag()) cpu.m_pc = 0x9860;
    ...
    // 98A3: BPL $00BA
    if (!cpu.negative_flag()) cpu.m_pc = 0x985F;
    ...
    // 98B4: BEQ $00DD
    if (cpu.zero_flag()) cpu.m_pc = 0x9893;
