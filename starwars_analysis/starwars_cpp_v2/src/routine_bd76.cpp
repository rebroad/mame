...
void routine_bd76_impl(StarWarsCPU& cpu) {
    // Converted from rom_disasm_bd76.md
    // Address: 0xBD76
    ...
    // BE28: BCS $00AC
    if (cpu.carry_flag()) cpu.state_.pc = 0xBDD6;
    ...
    // BE52: BPL $00D6
    if (!cpu.negative_flag()) cpu.state_.pc = 0xBE2A;
    ...
    // BE5F: BCS $00C4
    if (cpu.carry_flag()) cpu.state_.pc = 0xBE25;
    ...
    // BF4C: BEQ $0206
    if (cpu.zero_flag()) cpu.state_.pc = 0xBF54;
    ...
    // BF64: BCS $01F3
    if (cpu.carry_flag()) cpu.state_.pc = 0xBF59;
