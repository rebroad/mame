...
void routine_bd76_impl(StarWarsCPU& cpu) {
    ...
    // BE28: BCS $00AC
    if (cpu.carry_flag()) cpu.state_.pc = 0xBED6;
    ...
    // BE52: BPL $00D6
    if (!cpu.negative_flag()) cpu.state_.pc = 0xBF2A;
    ...
    // BF4C: BEQ $0206
    if (cpu.zero_flag()) cpu.state_.pc = 0xC154;
    ...
    // BF64: BCS $01F3
    if (cpu.carry_flag()) cpu.state_.pc = 0xC159;
