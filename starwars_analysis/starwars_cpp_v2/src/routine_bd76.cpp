...
void routine_bd76_impl(CPU6809& cpu) {
    ...
    // BE28: BCS $00AC
    if (cpu.carry_flag()) cpu.m_pc = 0xBDD6;
    ...
    // BE52: BPL $00D6
    if (!cpu.negative_flag()) cpu.m_pc = 0xBE2A;
    ...
    // BE5F: BCS $00C4
    if (cpu.carry_flag()) cpu.m_pc = 0xBE25;
    ...
    // BF4C: BEQ $0206
    if (cpu.zero_flag()) cpu.m_pc = 0xBF54;
    ...
    // BF64: BCS $01F3
    if (cpu.carry_flag()) cpu.m_pc = 0xBF59;
