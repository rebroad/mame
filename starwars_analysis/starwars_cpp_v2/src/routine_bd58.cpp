...
void routine_bd58_impl(StarWarsCPU& cpu) {
    ...
    // BE28: BCS $00CA
    if (cpu.carry_flag()) cpu.state_.pc = 0xBDF4;
    ...
    // BE52: BPL $00F4
    if (!cpu.negative_flag()) cpu.state_.pc = 0xBE48;
    ...
    // BE5F: BCS $00E2
    if (cpu.carry_flag()) cpu.state_.pc = 0xBE43;
    ...
    // BF4C: BEQ $0224
    if (cpu.zero_flag()) cpu.state_.pc = 0xBF72;
