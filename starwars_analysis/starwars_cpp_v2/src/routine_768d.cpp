...
void routine_768d_impl(StarWarsCPU& cpu) {
    ...
    // 7774: BPL $00ED
    if (!cpu.negative_flag()) cpu.state_.pc += 0x00ED;
    ...
    // 77B3: BPL $012C
    if (!cpu.negative_flag()) cpu.state_.pc += 0x012C;
    ...
    // 7841: BNE $01BB
    if (!cpu.zero_flag()) cpu.state_.pc += 0x01BB;
