...
void routine_bde9_impl(StarWarsCPU& cpu) {
    ...
    // BF4C: BEQ $0193
    if (cpu.zero_flag()) cpu.state_.pc = 0xBEE1;
    ...
    // BF64: BCS $0180
    if (cpu.carry_flag()) cpu.state_.pc = 0xBEE6;
    ...
    // BF77: BCS $0193
    if (cpu.carry_flag()) cpu.state_.pc = 0xBF0C;
    ...
    // BFA3: BEQ $01CB
    if (cpu.zero_flag()) cpu.state_.pc = 0xBF70;
