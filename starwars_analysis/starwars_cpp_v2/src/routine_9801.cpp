...
void routine_9801_impl(StarWarsCPU& cpu) {
    // Converted from rom_disasm_9801.md
    // Address: 0x9801
    ...
    // 9876: BNE $007D
    if (!cpu.zero_flag()) cpu.state_.pc = 0x98F5;
    ...
    // 9892: BEQ $0096
    if (cpu.zero_flag()) cpu.state_.pc = 0x982A;
    ...
    // 989C: BNE $00AE
    if (!cpu.zero_flag()) cpu.state_.pc = 0x984C;
    ...
    // 98A3: BPL $00A6
    if (!cpu.negative_flag()) cpu.state_.pc = 0x984B;
    ...
    // 98AD: BCS $00A0
    if (cpu.carry_flag()) cpu.state_.pc = 0x984F;
    ...
    // 98CD: LBRA $20EF
    // TODO: Convert LBRA $20EF

    // 98D0: BRA $00F2
    cpu.state_.pc = 0x98C4;

    // 98D2: BRN $00FA
    // TODO: Convert BRN $00FA

    // 98D4: BVC $00F5
    // TODO: Convert BVC $00F5
