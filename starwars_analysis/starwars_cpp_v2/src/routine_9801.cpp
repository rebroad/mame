...
void routine_9801_impl(StarWarsCPU& cpu) {
    ...
    // 989C: BNE $00AE
    if (!cpu.zero_flag()) cpu.state_.pc = 0x994C;
    ...
    // 98A3: BPL $00A6
    if (!cpu.negative_flag()) cpu.state_.pc = 0x994B;
    ...
    // 98AD: BCS $00A0
    if (cpu.carry_flag()) cpu.state_.pc = 0x994F;
