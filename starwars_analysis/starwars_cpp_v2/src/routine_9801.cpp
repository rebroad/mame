...
void routine_9801_impl(CPU6809& cpu) {
    ...
    // 9876: BNE $007D
    if (!cpu.zero_flag()) cpu.m_pc = 0x98F5;
    ...
    // 9892: BEQ $0096
    if (cpu.zero_flag()) cpu.m_pc = 0x982A;
    ...
    // 989C: BNE $00AE
    if (!cpu.zero_flag()) cpu.m_pc = 0x984C;
    ...
    // 98A3: BPL $00A6
    if (!cpu.negative_flag()) cpu.m_pc = 0x984B;
    ...
    // 98AD: BCS $00A0
    if (cpu.carry_flag()) cpu.m_pc = 0x984F;
