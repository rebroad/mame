...
void routine_ac52_impl(StarWarsCPU& cpu) {
    ...
    // AD98: BMI $0151
    if (cpu.negative_flag()) cpu.state_.pc += 0x0151;
    ...
    // AE06: BGE $020D
    // TODO: Convert BGE $020D

    // AE08: LDD $5004
    cpu.state_.d = cpu.read_memory_word(0x5004);

    // AE0B: BPL $01BF
    if (!cpu.negative_flag()) cpu.state_.pc += 0x01BF;
