...
void routine_bd12_impl(StarWarsCPU& cpu) {
    // Converted from rom_disasm_bd12.md
    // Address: 0xBD12
    ...
    // BE28: BCS $0110
    if (cpu.carry_flag()) cpu.state_.pc = 0xBE3A;
    ...
    // BE52: BPL $013A
    if (!cpu.negative_flag()) cpu.state_.pc = 0xBE8E;
    ...
    // BE5F: BCS $0128
    if (cpu.carry_flag()) cpu.state_.pc = 0xBE89;
