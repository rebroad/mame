...
void routine_bddf_impl(StarWarsCPU& cpu) {
    ...
    // BF4C: BEQ $019D
    if (cpu.zero_flag()) cpu.state_.pc = 0xC0EB;
    ...
    // BF64: BCS $018A
    if (cpu.carry_flag()) cpu.state_.pc = 0xC0F0;
    ...
    // BF77: BCS $019D
    if (cpu.carry_flag()) cpu.state_.pc = 0xC116;
    ...
    // BFA3: BEQ $01D5
    if (cpu.zero_flag()) cpu.state_.pc = 0xC17A;
