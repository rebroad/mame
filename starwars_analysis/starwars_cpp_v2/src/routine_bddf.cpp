...
void routine_bddf_impl(CPU6809& cpu) {
    ...
    // BE28: BCS $0043
    if (cpu.carry_flag()) cpu.m_pc = 0xBE6D;
    ...
    // BE52: BPL $006D
    if (!cpu.negative_flag()) cpu.m_pc = 0xBEC1;
    ...
    // BE5F: BCS $005B
    if (cpu.carry_flag()) cpu.m_pc = 0xBEBC;
    ...
    // BF4C: BEQ $019D
    if (cpu.zero_flag()) cpu.m_pc = 0xBEEB;
    ...
    // BF64: BCS $018A
    if (cpu.carry_flag()) cpu.m_pc = 0xBEF0;
    ...
    // BF77: BCS $019D
    if (cpu.carry_flag()) cpu.m_pc = 0xBF16;
    ...
    // BFA3: BEQ $01D5
    if (cpu.zero_flag()) cpu.m_pc = 0xBF7A;
