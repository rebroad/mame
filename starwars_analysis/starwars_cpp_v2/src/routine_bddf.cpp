...
void routine_bddf_impl(StarWarsCPU& cpu) {
    // Converted from rom_disasm_bddf.md
    // Address: 0xBDDF
    ...
    // BE28: BCS $0043
    if (cpu.carry_flag()) cpu.state_.pc = 0xBE6D;
    ...
    // BE52: BPL $006D
    if (!cpu.negative_flag()) cpu.state_.pc = 0xBEC1;
    ...
    // BE5F: BCS $005B
    if (cpu.carry_flag()) cpu.state_.pc = 0xBEBC;
    ...
    // BF4C: BEQ $019D
    if (cpu.zero_flag()) cpu.state_.pc = 0xBEEB;
    ...
    // BF64: BCS $018A
    if (cpu.carry_flag()) cpu.state_.pc = 0xBEF0;
    ...
    // BF77: BCS $019D
    if (cpu.carry_flag()) cpu.state_.pc = 0xBF16;
    ...
    // BFA3: BEQ $01D5
    if (cpu.zero_flag()) cpu.state_.pc = 0xBF7A;
