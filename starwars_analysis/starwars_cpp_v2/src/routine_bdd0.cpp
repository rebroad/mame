...
void routine_bdd0_impl(StarWarsCPU& cpu) {
    // Converted from rom_disasm_bdd0.md
    // Address: 0xBDD0
    ...
    // BE28: BCS $0052
    if (cpu.carry_flag()) cpu.state_.pc = 0xBE7C;
    ...
    // BE52: BPL $007C
    if (!cpu.negative_flag()) cpu.state_.pc = 0xBED0;
    ...
    // BE5F: BCS $006A
    if (cpu.carry_flag()) cpu.state_.pc = 0xBECB;
    ...
    // BF4C: BEQ $01AC
    if (cpu.zero_flag()) cpu.state_.pc = 0xC0FA;
    ...
    // BF64: BCS $0199
    if (cpu.carry_flag()) cpu.state_.pc = 0xC0FF;
    ...
    // BF77: BCS $01AC
    if (cpu.carry_flag()) cpu.state_.pc = 0xC125;
    ...
    // BFA3: BEQ $01E4
    if (cpu.zero_flag()) cpu.state_.pc = 0xC189;
