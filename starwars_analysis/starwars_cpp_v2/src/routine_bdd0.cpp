...
void routine_bdd0_impl(StarWarsCPU& cpu) {
    ...
    // BF4C: BEQ $01AC
    if (cpu.zero_flag()) cpu.state_.pc = 0xBEFA;
    ...
    // BF64: BCS $0199
    if (cpu.carry_flag()) cpu.state_.pc = 0xBEFF;
    ...
    // BF77: BCS $01AC
    if (cpu.carry_flag()) cpu.state_.pc = 0xBF25;
    ...
    // BFA3: BEQ $01E4
    if (cpu.zero_flag()) cpu.state_.pc = 0xBF89;
