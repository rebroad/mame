...
void routine_6dfa_impl(StarWarsCPU& cpu) {
    ...
    // 6E24: BEQ $0034
    if (cpu.zero_flag()) cpu.state_.pc += 0x0034;

    // 6E26: BLE $0031
    // TODO: Convert BLE $0031
    ...
    // 6E38: BPL $0044
    if (!cpu.negative_flag()) cpu.state_.pc += 0x0044;
    ...
    // 6E4A: BPL $0056
    if (!cpu.negative_flag()) cpu.state_.pc += 0x0056;
    ...
    // 6E63: BRA $0074
    cpu.state_.pc += 0x0074;

    // 6E65: CMPD #$FFF0
    // TODO: Convert CMPD #$FFF0

    // 6E69: BGE $0074
    // TODO: Convert BGE $0074
    ...
    // 6E72: BLE $0085
    // TODO: Convert BLE $0085

    // 6E74: CMPD #$0032
    // TODO: Convert CMPD #$0032

    // 6E78: BLE $0083
    // TODO: Convert BLE $0083
    ...
    // 6ED4: BMI $00E1
    if (cpu.negative_flag()) cpu.state_.pc += 0x00E1;

    // 6ED6: LDB $5084
    cpu.state_.b = cpu.read_memory(0x5084);

    // 6ED9: BRA $00E6
    cpu.state_.pc += 0x00E6;
    ...
    // 6F8B: BPL $0194
    if (!cpu.negative_flag()) cpu.state_.pc += 0x0194;

    // 6F90: TST <$7D
    // TODO: Convert TST <$7D

    // 6F92: BGE $019E
    // TODO: Convert BGE $019E
    ...
    // 6FAF: BPL $01B8
    if (!cpu.negative_flag()) cpu.state_.pc += 0x01B8;
    ...
    // 6FC9: BLE $01D6
    // TODO: Convert BLE $01D6

    // 6FCB: LDD #$1C00
    cpu.state_.d = 0x1C00;

    // 6FCE: BRA $01DF
    cpu.state_.pc += 0x01DF;
