...
void routine_bdda_impl(StarWarsCPU& cpu) {
    // Converted from rom_disasm_bdda.md
    // Address: 0xBDDA
    ...
    // BE28: BCS $0048
    if (cpu.carry_flag()) cpu.state_.pc = 0xBE72;
    ...
    // BE52: BPL $0072
    if (!cpu.negative_flag()) cpu.state_.pc = 0xBEC6;
    ...
    // BE5F: BCS $0060
    if (cpu.carry_flag()) cpu.state_.pc = 0xBEC1;
    ...
    // BF4C: BEQ $01A2
    if (cpu.zero_flag()) cpu.state_.pc = 0xBEF0;
    ...
    // BF64: BCS $018F
    if (cpu.carry_flag()) cpu.state_.pc = 0xBEF5;
    ...
    // BF77: BCS $01A2
    if (cpu.carry_flag()) cpu.state_.pc = 0xBF1B;
    ...
    // BFA3: BEQ $01DA
    if (cpu.zero_flag()) cpu.state_.pc = 0xBF7F;
    ...
    // BFD9: STB >$0000
    cpu.write_memory(0x0000, cpu.state_.b);
