...
void routine_8341_impl(StarWarsCPU& cpu) {
    ...
    // 8351: BCS $000B
    if (cpu.carry_flag()) cpu.state_.pc += 0x000B;
    ...
    // 840F: BNE $00D5
    if (!cpu.zero_flag()) cpu.state_.pc += 0x00D5;
    ...
    // 8508: BCS $01CC
    if (cpu.carry_flag()) cpu.state_.pc += 0x01CC;
    ...
    // 851D: BCS $01E1
    if (cpu.carry_flag()) cpu.state_.pc += 0x01E1;
