...
void routine_6ef7_impl(StarWarsCPU& cpu) {
    ...
    // 7090: BPL $019F
    if (!cpu.negative_flag()) cpu.state_.pc += 0x019F;
    ...
    // 70F2: BPL $01FE
    if (!cpu.negative_flag()) cpu.state_.pc += 0x01FE;
