...
void routine_bdb7_impl(StarWarsCPU& cpu) {
    // Converted from rom_disasm_bdb7.md
    // Address: 0xBDB7
    ...
    // BE28: BCS $006B
    if (cpu.carry_flag()) cpu.state_.pc = 0xBE95;
    ...
    // BE52: BPL $0095
    if (!cpu.negative_flag()) cpu.state_.pc = 0xBEE9;
    ...
    // BE5F: BCS $0083
    if (cpu.carry_flag()) cpu.state_.pc = 0xBEE4;
    ...
    // BF4C: BEQ $01C5
    if (cpu.zero_flag()) cpu.state_.pc = 0xC113;
    ...
    // BF64: BCS $01B2
    if (cpu.carry_flag()) cpu.state_.pc = 0xC118;
    ...
    // BF77: BCS $01C5
    if (cpu.carry_flag()) cpu.state_.pc = 0xC13E;
    ...
    // BFA3: BEQ $01FD
    if (cpu.zero_flag()) cpu.state_.pc = 0xC1A2;
