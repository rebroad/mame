...
void routine_bdb7_impl(StarWarsCPU& cpu) {
    ...
    // BE52: BPL $0095
    if (!cpu.negative_flag()) cpu.state_.pc = 0xBDE9;
    ...
    // BE5F: BCS $0083
    if (cpu.carry_flag()) cpu.state_.pc = 0xBDE4;
    ...
    // BF4C: BEQ $01C5
    if (cpu.zero_flag()) cpu.state_.pc = 0xBF13;
    ...
    // BF64: BCS $01B2
    if (cpu.carry_flag()) cpu.state_.pc = 0xBF18;
    ...
    // BF77: BCS $01C5
    if (cpu.carry_flag()) cpu.state_.pc = 0xBF3E;
    ...
    // BFA3: BEQ $01FD
    if (cpu.zero_flag()) cpu.state_.pc = 0xBFA2;
