...
void routine_bdb7_impl(CPU6809& cpu) {
    ...
    // BE28: BCS $006B
    if (cpu.carry_flag()) cpu.m_pc = 0xBE95;
    ...
    // BE52: BPL $0095
    if (!cpu.negative_flag()) cpu.m_pc = 0xBDE9;
    ...
    // BE5F: BCS $0083
    if (cpu.carry_flag()) cpu.m_pc = 0xBDE4;
    ...
    // BF4C: BEQ $01C5
    if (cpu.zero_flag()) cpu.m_pc = 0xBF13;
    ...
    // BF64: BCS $01B2
    if (cpu.carry_flag()) cpu.m_pc = 0xBF18;
    ...
    // BF77: BCS $01C5
    if (cpu.carry_flag()) cpu.m_pc = 0xBF3E;
    ...
    // BFA3: BEQ $01FD
    if (cpu.zero_flag()) cpu.m_pc = 0xBFA2;
