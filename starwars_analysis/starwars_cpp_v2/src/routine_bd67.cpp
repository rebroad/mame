...
void routine_bd67_impl(CPU6809& cpu) {
    ...
    // BE28: BCS $00BB
    if (cpu.carry_flag()) cpu.m_pc = 0xBDE5;
    ...
    // BE52: BPL $00E5
    if (!cpu.negative_flag()) cpu.m_pc = 0xBE39;
    ...
    // BE5F: BCS $00D3
    if (cpu.carry_flag()) cpu.m_pc = 0xBE34;
    ...
    // BF4C: BEQ $0215
    if (cpu.zero_flag()) cpu.m_pc = 0xBF63;
    ...
    // BF64: BCS $0202
    if (cpu.carry_flag()) cpu.m_pc = 0xBF68;
