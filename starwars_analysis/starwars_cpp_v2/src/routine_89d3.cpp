...
void routine_89d3_impl(StarWarsCPU& cpu) {
    ...
    // 8B51: BPL $0145
    if (!cpu.negative_flag()) cpu.state_.pc += 0x0145;
    ...
    // 8B83: BCS $019D
    if (cpu.carry_flag()) cpu.state_.pc += 0x019D;
    ...
    // 8BC1: BPL $01F1
    if (!cpu.negative_flag()) cpu.state_.pc += 0x01F1;

    // 8BC4: CMPA #$08
    cpu.compare_a(0x08);

    // 8BC6: BGT $0203
    // TODO: Convert BGT $0203
