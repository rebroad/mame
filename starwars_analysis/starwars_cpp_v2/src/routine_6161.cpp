...
void routine_6161_impl(StarWarsCPU& cpu) {
    ...
    // 6167: BNE $0010
    if (!cpu.zero_flag()) cpu.state_.pc += 0x0010;
    ...
    // 622A: BCS $00B1
    if (cpu.carry_flag()) cpu.state_.pc += 0x00B1;
    ...
    // 6237: BEQ $00DB
    if (cpu.zero_flag()) cpu.state_.pc += 0x00DB;
