...
void routine_ce0c_impl(StarWarsCPU& cpu) {
    // Converted from rom_disasm_ce0c.md
    // Address: 0xCE0C
    ...
    // CED3: BRA $00FA
    cpu.state_.pc = 0xCFCF;

    // CED6: XANDCC #$33
    // TODO: Convert XANDCC #$33

    // CED8: BRA $010F
    cpu.state_.pc = 0xCFE9;
    ...
    // CFF5: BCC $01EA
    if (!cpu.carry_flag()) cpu.state_.pc = 0xD1E1;
    ...
    // CFFE: SUBB $01B0,PCR
    // TODO: Fix comma operator: SUBB $01B0,PCR

    // D001: ORA <$1F
    cpu.state_.a |= 0x1F;

    // D003: BCC $01F8
    if (!cpu.carry_flag()) cpu.state_.pc = 0xD1FD;
