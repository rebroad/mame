...
void routine_bd00_impl(StarWarsCPU& cpu) {
    // Converted from rom_disasm_bd00.md
    // Address: 0xBD00
    ...
    // BE28: BCS $0122
    if (cpu.carry_flag()) cpu.state_.pc = 0xBF4C;
    ...
    // BE52: BPL $014C
    if (!cpu.negative_flag()) cpu.state_.pc = 0xBFA0;
    ...
    // BE5F: BCS $013A
    if (cpu.carry_flag()) cpu.state_.pc = 0xBF9B;
