...
void routine_be07_impl(StarWarsCPU& cpu) {
    // Converted from rom_disasm_be07.md
    // Address: 0xBE07
    ...
    // BE28: BCS $001B
    if (cpu.carry_flag()) cpu.state_.pc = 0xBE45;
    ...
    // BE52: BPL $0045
    if (!cpu.negative_flag()) cpu.state_.pc = 0xBE99;
    ...
    // BE5F: BCS $0033
    if (cpu.carry_flag()) cpu.state_.pc = 0xBE94;
    ...
    // BF4C: BEQ $0175
    if (cpu.zero_flag()) cpu.state_.pc = 0xBFC3;
    ...
    // BF64: BCS $0162
    if (cpu.carry_flag()) cpu.state_.pc = 0xBFC8;
    ...
    // BF77: BCS $0175
    if (cpu.carry_flag()) cpu.state_.pc = 0xBFEE;
    ...
    // BFA3: BEQ $01AD
    if (cpu.zero_flag()) cpu.state_.pc = 0xBF52;
