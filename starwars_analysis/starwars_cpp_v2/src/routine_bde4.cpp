...
void routine_bde4_impl(StarWarsCPU& cpu) {
    // Converted from rom_disasm_bde4.md
    // Address: 0xBDE4
    ...
    // BE28: BCS $003E
    if (cpu.carry_flag()) cpu.state_.pc = 0xBE68;
    ...
    // BE52: BPL $0068
    if (!cpu.negative_flag()) cpu.state_.pc = 0xBEBC;
    ...
    // BE5F: BCS $0056
    if (cpu.carry_flag()) cpu.state_.pc = 0xBEB7;
    ...
    // BF4C: BEQ $0198
    if (cpu.zero_flag()) cpu.state_.pc = 0xBEE6;
    ...
    // BF64: BCS $0185
    if (cpu.carry_flag()) cpu.state_.pc = 0xBEEB;
    ...
    // BF77: BCS $0198
    if (cpu.carry_flag()) cpu.state_.pc = 0xBF11;
    ...
    // BFA3: BEQ $01D0
    if (cpu.zero_flag()) cpu.state_.pc = 0xBF75;
    ...
    // BFE2: LDU $4A00
    cpu.state_.u = cpu.read_memory_word(0x4A00);
