...
void routine_bde4_impl(StarWarsCPU& cpu) {
    ...
    // BF4C: BEQ $0198
    if (cpu.zero_flag()) cpu.state_.pc = 0xC0E6;
    ...
    // BF64: BCS $0185
    if (cpu.carry_flag()) cpu.state_.pc = 0xC0EB;
    ...
    // BF77: BCS $0198
    if (cpu.carry_flag()) cpu.state_.pc = 0xC111;
    ...
    // BFA3: BEQ $01D0
    if (cpu.zero_flag()) cpu.state_.pc = 0xC175;
