...
void routine_6ea1_impl(StarWarsCPU& cpu) {
    ...
    // 6EE6: BMI $004C
    if (cpu.negative_flag()) cpu.state_.pc += 0x004C;
    ...
    // 7089: BPL $01EB
    if (!cpu.negative_flag()) cpu.state_.pc += 0x01EB;
