...
void routine_89e9_impl(StarWarsCPU& cpu) {
    ...
    // 8AE3: BNE $0104
    if (!cpu.zero_flag()) cpu.state_.pc += 0x0104;
    ...
    // 8B30: BCS $014A
    if (cpu.carry_flag()) cpu.state_.pc += 0x014A;
    ...
    // 8BC6: BGT $01ED
    // TODO: Convert BGT $01ED

    // 8BC8: LDA $C,U
    // TODO: Fix comma operator: LDA $C,U

    // 8BCB: BPL $01E5
    if (!cpu.negative_flag()) cpu.state_.pc += 0x01E5;
