...
void routine_adaf_impl(StarWarsCPU& cpu) {
    ...
    // AEAA: BNE $0100
    if (!cpu.zero_flag()) cpu.state_.pc += 0x0100;
    ...
    // AFA3: BMI $01F9
    if (cpu.negative_flag()) cpu.state_.pc += 0x01F9;
