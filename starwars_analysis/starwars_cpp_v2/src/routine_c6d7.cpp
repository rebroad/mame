...
void routine_c6d7_impl(StarWarsCPU& cpu) {
    ...
    // C88C: BMI $01D2
    if (cpu.negative_flag()) cpu.state_.pc += 0x01D2;
    ...
    // C893: BNE $01CE
    if (!cpu.zero_flag()) cpu.state_.pc += 0x01CE;
    ...
    // C89A: BNE $01CA
    if (!cpu.zero_flag()) cpu.state_.pc += 0x01CA;
    ...
    // C8C4: BMI $020A
    if (cpu.negative_flag()) cpu.state_.pc += 0x020A;
    ...
    // C8CB: BNE $0206
    if (!cpu.zero_flag()) cpu.state_.pc += 0x0206;
