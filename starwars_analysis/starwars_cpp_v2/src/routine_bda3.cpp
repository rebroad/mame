...
void routine_bda3_impl(StarWarsCPU& cpu) {
    // Converted from rom_disasm_bda3.md
    // Address: 0xBDA3
    ...
    // BE28: BCS $007F
    if (cpu.carry_flag()) cpu.state_.pc = 0xBEA9;
    ...
    // BE52: BPL $00A9
    if (!cpu.negative_flag()) cpu.state_.pc = 0xBDFD;
    ...
    // BE5F: BCS $0097
    if (cpu.carry_flag()) cpu.state_.pc = 0xBDF8;
    ...
    // BF4C: BEQ $01D9
    if (cpu.zero_flag()) cpu.state_.pc = 0xBF27;
    ...
    // BF64: BCS $01C6
    if (cpu.carry_flag()) cpu.state_.pc = 0xBF2C;
    ...
    // BF77: BCS $01D9
    if (cpu.carry_flag()) cpu.state_.pc = 0xBF52;
