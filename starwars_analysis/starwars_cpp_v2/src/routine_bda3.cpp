...
void routine_bda3_impl(StarWarsCPU& cpu) {
    ...
    // BE52: BPL $00A9
    if (!cpu.negative_flag()) cpu.state_.pc = 0xBEFD;
    ...
    // BE5F: BCS $0097
    if (cpu.carry_flag()) cpu.state_.pc = 0xBEF8;
    ...
    // BF4C: BEQ $01D9
    if (cpu.zero_flag()) cpu.state_.pc = 0xC127;
    ...
    // BF64: BCS $01C6
    if (cpu.carry_flag()) cpu.state_.pc = 0xC12C;
    ...
    // BF77: BCS $01D9
    if (cpu.carry_flag()) cpu.state_.pc = 0xC152;
