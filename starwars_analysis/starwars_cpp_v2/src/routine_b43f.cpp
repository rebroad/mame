...
void routine_b43f_impl(StarWarsCPU& cpu) {
    ...
    // B4CD: BLT $00D7
    // TODO: Convert BLT $00D7

    // B4CF: LDD $5042
    cpu.state_.d = cpu.read_memory_word(0x5042);

    // B4D2: BGT $00CC
    // TODO: Convert BGT $00CC
    ...
    // B506: BPL $00CA
    if (!cpu.negative_flag()) cpu.state_.pc += 0x00CA;
    ...
    // B536: BMI $00FE
    if (cpu.negative_flag()) cpu.state_.pc += 0x00FE;
    ...
    // B607: BLT $0211
    // TODO: Convert BLT $0211

    // B609: LDD $5042
    cpu.state_.d = cpu.read_memory_word(0x5042);

    // B60C: BLT $0206
    // TODO: Convert BLT $0206
