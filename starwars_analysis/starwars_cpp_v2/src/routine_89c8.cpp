...
void routine_89c8_impl(StarWarsCPU& cpu) {
    ...
    // 8B76: BEQ $01B3
    if (cpu.zero_flag()) cpu.state_.pc += 0x01B3;
    ...
    // 8B91: BNE $020E
    if (!cpu.zero_flag()) cpu.state_.pc += 0x020E;
