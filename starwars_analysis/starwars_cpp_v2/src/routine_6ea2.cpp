...
void routine_6ea2_impl(StarWarsCPU& cpu) {
    ...
    // 6EC9: BCS $0008
    if (cpu.carry_flag()) cpu.state_.pc += 0x0008;
    ...
    // 6F8B: BPL $00EC
    if (!cpu.negative_flag()) cpu.state_.pc += 0x00EC;

    // 6F90: TST <$7D
    // TODO: Convert TST <$7D

    // 6F92: BGE $00F6
    // TODO: Convert BGE $00F6
    ...
    // 6FAF: BPL $0110
    if (!cpu.negative_flag()) cpu.state_.pc += 0x0110;
