...
void routine_cdb5_impl(StarWarsCPU& cpu) {
    // Converted from rom_disasm_cdb5.md
    // Address: 0xCDB5
    ...
    // CDC0: BMI $0008
    if (cpu.negative_flag()) cpu.state_.pc = 0xCDCA;
    ...
    // CE5A: BRA $00EE
    cpu.state_.pc = 0xCE4A;

    // CE5E: BRA $0102
    cpu.state_.pc = 0xCE62;
    ...
    // CED3: BRA $0151
    cpu.state_.pc = 0xCF26;

    // CED6: XANDCC #$33
    // TODO: Convert XANDCC #$33

    // CED8: BRA $0166
    cpu.state_.pc = 0xCF40;
