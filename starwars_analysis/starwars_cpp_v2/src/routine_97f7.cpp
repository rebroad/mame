...
void routine_97f7_impl(StarWarsCPU& cpu) {
    ...
    // 9876: BNE $0087
    if (!cpu.zero_flag()) cpu.state_.pc = 0x97FF;
    ...
    // 98A3: BPL $00B0
    if (!cpu.negative_flag()) cpu.state_.pc = 0x9855;
    ...
    // 98AD: BCS $00AA
    if (cpu.carry_flag()) cpu.state_.pc = 0x9859;
    ...
    // 98B4: BEQ $00D3
    if (cpu.zero_flag()) cpu.state_.pc = 0x9889;
