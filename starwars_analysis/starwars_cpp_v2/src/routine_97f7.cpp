...
void routine_97f7_impl(StarWarsCPU& cpu) {
    ...
    // 9876: BNE $0087
    if (!cpu.zero_flag()) cpu.state_.pc = 0x98FF;
    ...
    // 989C: BNE $00B8
    if (!cpu.zero_flag()) cpu.state_.pc = 0x9956;
    ...
    // 98A3: BPL $00B0
    if (!cpu.negative_flag()) cpu.state_.pc = 0x9955;
    ...
    // 98B4: BEQ $00D3
    if (cpu.zero_flag()) cpu.state_.pc = 0x9989;
