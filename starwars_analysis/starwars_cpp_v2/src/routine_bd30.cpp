...
void routine_bd30_impl(StarWarsCPU& cpu) {
    // Converted from rom_disasm_bd30.md
    // Address: 0xBD30
    ...
    // BE28: BCS $00F2
    if (cpu.carry_flag()) cpu.state_.pc = 0xBE1C;
    ...
    // BE52: BPL $011C
    if (!cpu.negative_flag()) cpu.state_.pc = 0xBE70;
    ...
    // BE5F: BCS $010A
    if (cpu.carry_flag()) cpu.state_.pc = 0xBE6B;
