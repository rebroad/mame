...
void routine_8961_impl(StarWarsCPU& cpu) {
    // Converted from rom_disasm_8961.md
    // Address: 0x8961
    ...
    // 8AD9: BEQ $017B
    if (cpu.zero_flag()) cpu.state_.pc = 0x8B56;
    ...
    // 8AE3: BNE $018C
    if (!cpu.zero_flag()) cpu.state_.pc = 0x8A71;
    ...
    // 8B30: BCS $01D2
    if (cpu.carry_flag()) cpu.state_.pc = 0x8B04;
    ...
    // 8B51: BPL $01B7
    if (!cpu.negative_flag()) cpu.state_.pc = 0x8B0A;
