...
void routine_cdb1_impl(StarWarsCPU& cpu) {
    // Converted from rom_disasm_cdb1.md
    // Address: 0xCDB1
    ...
    // CDC0: BMI $000C
    if (cpu.negative_flag()) cpu.state_.pc = 0xCDCE;
    ...
    // CE5A: BRA $00F2
    cpu.state_.pc = 0xCE4E;

    // CE5E: BRA $0106
    cpu.state_.pc = 0xCE66;
    ...
    // CED3: BRA $0155
    cpu.state_.pc = 0xCF2A;

    // CED6: XANDCC #$33
    // TODO: Convert XANDCC #$33

    // CED8: BRA $016A
    cpu.state_.pc = 0xCF44;
