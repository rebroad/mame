...
void routine_8ab6_impl(StarWarsCPU& cpu) {
    ...
    // 8BC1: BPL $010E
    if (!cpu.negative_flag()) cpu.state_.pc += 0x010E;
    ...
    // 8BDE: BCS $00D3
    if (cpu.carry_flag()) cpu.state_.pc += 0x00D3;
    ...
    // 8BFF: BMI $015F
    if (cpu.negative_flag()) cpu.state_.pc += 0x015F;
    ...
    // 8C38: BCC $0187
    if (!cpu.carry_flag()) cpu.state_.pc += 0x0187;
    ...
    // 8CB3: BEQ $024F
    if (cpu.zero_flag()) cpu.state_.pc += 0x024F;
