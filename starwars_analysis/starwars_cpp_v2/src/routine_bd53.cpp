...
void routine_bd53_impl(StarWarsCPU& cpu) {
    // Converted from rom_disasm_bd53.md
    // Address: 0xBD53
    ...
    // BE28: BCS $00CF
    if (cpu.carry_flag()) cpu.state_.pc = 0xBDF9;
    ...
    // BE52: BPL $00F9
    if (!cpu.negative_flag()) cpu.state_.pc = 0xBE4D;
    ...
    // BE5F: BCS $00E7
    if (cpu.carry_flag()) cpu.state_.pc = 0xBE48;
    ...
    // BF4C: BEQ $0229
    if (cpu.zero_flag()) cpu.state_.pc = 0xBF77;
