...
void routine_cd74_impl(StarWarsCPU& cpu) {
    // Converted from rom_disasm_cd74.md
    // Address: 0xCD74
    ...
    // CDC0: BMI $0049
    if (cpu.negative_flag()) cpu.state_.pc = 0xCE0B;
    ...
    // CE5A: BRA $012F
    cpu.state_.pc = 0xCF8B;

    // CE5E: BRA $0143
    cpu.state_.pc = 0xCFA3;
    ...
    // CED3: BRA $0192
    cpu.state_.pc = 0xD067;

    // CED6: XANDCC #$33
    // TODO: Convert XANDCC #$33

    // CED8: BRA $01A7
    cpu.state_.pc = 0xD081;
