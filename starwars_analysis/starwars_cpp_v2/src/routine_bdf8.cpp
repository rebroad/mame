...
void routine_bdf8_impl(StarWarsCPU& cpu) {
    // Converted from rom_disasm_bdf8.md
    // Address: 0xBDF8
    ...
    // BE28: BCS $002A
    if (cpu.carry_flag()) cpu.state_.pc = 0xBE54;
    ...
    // BE52: BPL $0054
    if (!cpu.negative_flag()) cpu.state_.pc = 0xBEA8;
    ...
    // BE5F: BCS $0042
    if (cpu.carry_flag()) cpu.state_.pc = 0xBEA3;
    ...
    // BF4C: BEQ $0184
    if (cpu.zero_flag()) cpu.state_.pc = 0xC0D2;
    ...
    // BF64: BCS $0171
    if (cpu.carry_flag()) cpu.state_.pc = 0xC0D7;
    ...
    // BF77: BCS $0184
    if (cpu.carry_flag()) cpu.state_.pc = 0xC0FD;
    ...
    // BFA3: BEQ $01BC
    if (cpu.zero_flag()) cpu.state_.pc = 0xC161;
    ...
    // BFED: BCS $01FC
    if (cpu.carry_flag()) cpu.state_.pc = 0xC1EB;

    // BFEF: LDD #$1ED4
    cpu.state_.d = 0x1ED4;

    // BFF2: BRA $01FF
    cpu.state_.pc = 0xC1F3;
