...
void routine_bdd5_impl(CPU6809& cpu) {
    ...
    // BE28: BCS $004D
    if (cpu.carry_flag()) cpu.m_pc = 0xBE77;
    ...
    // BE52: BPL $0077
    if (!cpu.negative_flag()) cpu.m_pc = 0xBECB;
    ...
    // BE5F: BCS $0065
    if (cpu.carry_flag()) cpu.m_pc = 0xBEC6;
    ...
    // BF4C: BEQ $01A7
    if (cpu.zero_flag()) cpu.m_pc = 0xBEF5;
    ...
    // BF64: BCS $0194
    if (cpu.carry_flag()) cpu.m_pc = 0xBEFA;
    ...
    // BF77: BCS $01A7
    if (cpu.carry_flag()) cpu.m_pc = 0xBF20;
    ...
    // BFA3: BEQ $01DF
    if (cpu.zero_flag()) cpu.m_pc = 0xBF84;
