...
void routine_bdd5_impl(StarWarsCPU& cpu) {
    ...
    // BF4C: BEQ $01A7
    if (cpu.zero_flag()) cpu.state_.pc = 0xC0F5;
    ...
    // BF64: BCS $0194
    if (cpu.carry_flag()) cpu.state_.pc = 0xC0FA;
    ...
    // BF77: BCS $01A7
    if (cpu.carry_flag()) cpu.state_.pc = 0xC120;
    ...
    // BFA3: BEQ $01DF
    if (cpu.zero_flag()) cpu.state_.pc = 0xC184;
