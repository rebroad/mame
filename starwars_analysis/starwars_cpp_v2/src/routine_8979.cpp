...
void routine_8979_impl(CPU6809& cpu) {
    ...
    // 8AD9: BEQ $0163
    if (cpu.zero_flag()) cpu.m_pc = 0x8B3E;
    ...
    // 8AE3: BNE $0174
    if (!cpu.zero_flag()) cpu.m_pc = 0x8B59;
    ...
    // 8B30: BCS $01BA
    if (cpu.carry_flag()) cpu.m_pc = 0x8AEC;
    ...
    // 8B42: BCS $01CC
    if (cpu.carry_flag()) cpu.m_pc = 0x8B10;
    ...
    // 8B51: BPL $019F
    if (!cpu.negative_flag()) cpu.m_pc = 0x8AF2;
    ...
    // 8B61: BNE $01ED
    if (!cpu.zero_flag()) cpu.m_pc = 0x8B50;
    ...
    // 8B76: BEQ $0202
    if (cpu.zero_flag()) cpu.m_pc = 0x8B7A;
