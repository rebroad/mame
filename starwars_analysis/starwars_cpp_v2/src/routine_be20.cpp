...
void routine_be20_impl(CPU6809& cpu) {
    ...
    // BE28: BCS $0002
    if (cpu.carry_flag()) cpu.m_pc = 0xBE2C;
    ...
    // BE52: BPL $002C
    if (!cpu.negative_flag()) cpu.m_pc = 0xBE80;
    ...
    // BE5F: BCS $001A
    if (cpu.carry_flag()) cpu.m_pc = 0xBE7B;
    ...
    // BF4C: BEQ $015C
    if (cpu.zero_flag()) cpu.m_pc = 0xBFAA;
    ...
    // BF64: BCS $0149
    if (cpu.carry_flag()) cpu.m_pc = 0xBFAF;
    ...
    // BF77: BCS $015C
    if (cpu.carry_flag()) cpu.m_pc = 0xBFD5;
    ...
    // BFA3: BEQ $0194
    if (cpu.zero_flag()) cpu.m_pc = 0xBF39;
    ...
    // BFED: BCS $01D4
    if (cpu.carry_flag()) cpu.m_pc = 0xBFC3;
