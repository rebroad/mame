...
void routine_be20_impl(StarWarsCPU& cpu) {
    ...
    // BF4C: BEQ $015C
    if (cpu.zero_flag()) cpu.state_.pc = 0xBFAA;
    ...
    // BF64: BCS $0149
    if (cpu.carry_flag()) cpu.state_.pc = 0xBFAF;
    ...
    // BF77: BCS $015C
    if (cpu.carry_flag()) cpu.state_.pc = 0xBFD5;
    ...
    // BFA3: BEQ $0194
    if (cpu.zero_flag()) cpu.state_.pc = 0xBF39;
    ...
    // BFED: BCS $01D4
    if (cpu.carry_flag()) cpu.state_.pc = 0xBFC3;

    // BFEF: LDD #$1ED4
    cpu.state_.d = 0x1ED4;

    // BFF2: BRA $01D7
    cpu.state_.pc = 0xBFCB;
