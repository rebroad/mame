...
void routine_d95e_impl(StarWarsCPU& cpu) {
    ...
    // DAA9: BCS $0153
    if (cpu.carry_flag()) cpu.state_.pc += 0x0153;
    ...
    // DAFC: BCS $01A5
    if (cpu.carry_flag()) cpu.state_.pc += 0x01A5;
    ...
    // DB43: BRA $023E
    cpu.state_.pc += 0x023E;

    // DB47: ADDD <$40
    cpu.state_.d += 0x40;

    // DB49: BRA $021E
    cpu.state_.pc += 0x021E;
    ...
    // DB58: BRA $0248
    cpu.state_.pc += 0x0248;

    // DB5C: BGT $0220
    // TODO: Convert BGT $0220
