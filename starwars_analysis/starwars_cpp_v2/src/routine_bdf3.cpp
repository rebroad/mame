...
void routine_bdf3_impl(StarWarsCPU& cpu) {
    // Converted from rom_disasm_bdf3.md
    // Address: 0xBDF3
    ...
    // BE28: BCS $002F
    if (cpu.carry_flag()) cpu.state_.pc = 0xBE59;
    ...
    // BE52: BPL $0059
    if (!cpu.negative_flag()) cpu.state_.pc = 0xBEAD;
    ...
    // BE5F: BCS $0047
    if (cpu.carry_flag()) cpu.state_.pc = 0xBEA8;
    ...
    // BF4C: BEQ $0189
    if (cpu.zero_flag()) cpu.state_.pc = 0xBED7;
    ...
    // BF64: BCS $0176
    if (cpu.carry_flag()) cpu.state_.pc = 0xBFDC;
    ...
    // BF77: BCS $0189
    if (cpu.carry_flag()) cpu.state_.pc = 0xBF02;
    ...
    // BFA3: BEQ $01C1
    if (cpu.zero_flag()) cpu.state_.pc = 0xBF66;
    ...
    // BFED: BCS $0201
    if (cpu.carry_flag()) cpu.state_.pc = 0xBFF0;

    // BFEF: LDD #$1ED4
    cpu.state_.d = 0x1ED4;

    // BFF2: BRA $0201
    cpu.state_.pc = 0xBFF5;
