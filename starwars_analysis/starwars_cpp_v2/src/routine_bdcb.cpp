...
void routine_bdcb_impl(CPU6809& cpu) {
    // Converted from rom_disasm_bdcb.md
    // Address: 0xBDCB
    ...
    // BE28: BCS $0057
    if (cpu.carry_flag()) cpu.m_pc = 0xBE81;
    ...
    // BE52: BPL $0081
    if (!cpu.negative_flag()) cpu.m_pc = 0xBDD5;
    ...
    // BE5F: BCS $006F
    if (cpu.carry_flag()) cpu.m_pc = 0xBED0;
    ...
    // BF4C: BEQ $01B1
    if (cpu.zero_flag()) cpu.m_pc = 0xBEFF;
    ...
    // BF64: BCS $019E
    if (cpu.carry_flag()) cpu.m_pc = 0xBF04;
    ...
    // BF77: BCS $01B1
    if (cpu.carry_flag()) cpu.m_pc = 0xBF2A;
    ...
    // BFA3: BEQ $01E9
    if (cpu.zero_flag()) cpu.m_pc = 0xBF8E;
