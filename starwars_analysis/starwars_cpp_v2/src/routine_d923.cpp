...
void routine_d923_impl(StarWarsCPU& cpu) {
    // Converted from rom_disasm_d923.md
    // Address: 0xD923
    ...
    // D92A: BCC $001E
    if (!cpu.carry_flag()) cpu.state_.pc = 0xD94A;
    ...
    // D949: BCC $003A
    if (!cpu.carry_flag()) cpu.state_.pc = 0xD985;
    ...
    // D976: BNE $0059
    if (!cpu.zero_flag()) cpu.state_.pc = 0xD9D1;
    ...
    // D982: BCS $0051
    if (cpu.carry_flag()) cpu.state_.pc = 0xD9D5;
    ...
    // D98C: BCC $00B8
    if (!cpu.carry_flag()) cpu.state_.pc = 0xD946;
    ...
    // D995: BEQ $00B0
    if (cpu.zero_flag()) cpu.state_.pc = 0xD947;
    ...
    // D9D9: BCS $0070
    if (cpu.carry_flag()) cpu.state_.pc = 0xDA4B;
    ...
    // DA07: LBCC $0171
    // TODO: Convert LBCC $0171

    // DA0B: CMPD #$0040
    // TODO: Convert CMPD #$0040

    // DA0F: BCC $00FB
    if (!cpu.carry_flag()) cpu.state_.pc = 0xDA0C;
    ...
    // DA9A: BCC $01D2
    if (!cpu.carry_flag()) cpu.state_.pc = 0xDA6E;
    ...
    // DAA9: BCS $018E
    if (cpu.carry_flag()) cpu.state_.pc = 0xDA39;
    ...
    // DAB1: BRA $01CB
    cpu.state_.pc = 0xDA7E;

    // DAB3: CMPD #$0160
    // TODO: Convert CMPD #$0160

    // DAB7: BCC $019E
    if (!cpu.carry_flag()) cpu.state_.pc = 0xDA57;
    ...
    // DACB: BCS $01CB
    if (cpu.carry_flag()) cpu.state_.pc = 0xDA98;
    ...
    // DAD5: BNE $01BC
    if (!cpu.zero_flag()) cpu.state_.pc = 0xDA93;
    ...
    // DB07: BCS $020B
    if (cpu.carry_flag()) cpu.state_.pc = 0xDB14;
    ...
    // DB15: BCS $01FC
    if (cpu.carry_flag()) cpu.state_.pc = 0xDB13;
